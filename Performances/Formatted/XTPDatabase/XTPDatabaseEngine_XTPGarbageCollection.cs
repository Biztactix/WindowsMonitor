...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_XTPDatabaseEngine_XTPGarbageCollection
    {
        ...
        public static PerfFormattedData_XTPDatabaseEngine_XTPGarbageCollection[] Retrieve(string remote,
        ...
        public static PerfFormattedData_XTPDatabaseEngine_XTPGarbageCollection[] Retrieve()
        {
        ...
        {
            var objectQuery =
                new ObjectQuery("SELECT * FROM Win32_PerfFormattedData_XTPDatabaseEngine_XTPGarbageCollection");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfFormattedData_XTPDatabaseEngine_XTPGarbageCollection>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_XTPDatabaseEngine_XTPGarbageCollection
                {
