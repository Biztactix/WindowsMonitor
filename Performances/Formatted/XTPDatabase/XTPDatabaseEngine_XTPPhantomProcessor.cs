...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_XTPDatabaseEngine_XTPPhantomProcessor
    {
        ...
        public static PerfFormattedData_XTPDatabaseEngine_XTPPhantomProcessor[] Retrieve(string remote, string username,
            string password)
        {
        ...
        public static PerfFormattedData_XTPDatabaseEngine_XTPPhantomProcessor[] Retrieve()
        {
        ...
        {
            var objectQuery =
                new ObjectQuery("SELECT * FROM Win32_PerfFormattedData_XTPDatabaseEngine_XTPPhantomProcessor");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfFormattedData_XTPDatabaseEngine_XTPPhantomProcessor>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_XTPDatabaseEngine_XTPPhantomProcessor
                {
