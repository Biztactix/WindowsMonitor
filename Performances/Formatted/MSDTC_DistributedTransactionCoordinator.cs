...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_MSDTC_DistributedTransactionCoordinator
    {
        ...
        public static PerfFormattedData_MSDTC_DistributedTransactionCoordinator[] Retrieve(string remote,
        ...
        public static PerfFormattedData_MSDTC_DistributedTransactionCoordinator[] Retrieve()
        {
        ...
        {
            var objectQuery =
                new ObjectQuery("SELECT * FROM Win32_PerfFormattedData_MSDTC_DistributedTransactionCoordinator");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfFormattedData_MSDTC_DistributedTransactionCoordinator>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_MSDTC_DistributedTransactionCoordinator
                {
