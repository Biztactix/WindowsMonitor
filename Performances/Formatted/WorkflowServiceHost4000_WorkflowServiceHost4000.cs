...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_WorkflowServiceHost4000_WorkflowServiceHost4000
    {
        ...
        public static PerfFormattedData_WorkflowServiceHost4000_WorkflowServiceHost4000[] Retrieve(string remote,
        ...
        public static PerfFormattedData_WorkflowServiceHost4000_WorkflowServiceHost4000[] Retrieve()
        {
            ...
            ManagementScope managementScope)
        {
            var objectQuery =
                new ObjectQuery(
                    "SELECT * FROM Win32_PerfFormattedData_WorkflowServiceHost4000_WorkflowServiceHost4000");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfFormattedData_WorkflowServiceHost4000_WorkflowServiceHost4000>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_WorkflowServiceHost4000_WorkflowServiceHost4000
                {
