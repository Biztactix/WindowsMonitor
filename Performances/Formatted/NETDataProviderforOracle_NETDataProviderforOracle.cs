...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_NETDataProviderforOracle_NETDataProviderforOracle
    {
        ...
        public static PerfFormattedData_NETDataProviderforOracle_NETDataProviderforOracle[] Retrieve(string remote,
        ...
        public static PerfFormattedData_NETDataProviderforOracle_NETDataProviderforOracle[] Retrieve()
        {
            ...
            ManagementScope managementScope)
        {
            var objectQuery =
                new ObjectQuery(
                    "SELECT * FROM Win32_PerfFormattedData_NETDataProviderforOracle_NETDataProviderforOracle");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfFormattedData_NETDataProviderforOracle_NETDataProviderforOracle>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_NETDataProviderforOracle_NETDataProviderforOracle
                {
