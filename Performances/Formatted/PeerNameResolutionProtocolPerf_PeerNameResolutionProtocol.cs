...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_PeerNameResolutionProtocolPerf_PeerNameResolutionProtocol
    {
        ...
        public static PerfFormattedData_PeerNameResolutionProtocolPerf_PeerNameResolutionProtocol[] Retrieve(
            ...
            ManagementScope managementScope)
        {
            var objectQuery =
                new ObjectQuery(
                    "SELECT * FROM Win32_PerfFormattedData_PeerNameResolutionProtocolPerf_PeerNameResolutionProtocol");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfFormattedData_PeerNameResolutionProtocolPerf_PeerNameResolutionProtocol>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_PeerNameResolutionProtocolPerf_PeerNameResolutionProtocol
                {
