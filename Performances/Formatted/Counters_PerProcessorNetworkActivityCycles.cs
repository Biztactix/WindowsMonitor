...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_Counters_PerProcessorNetworkActivityCycles
    {
        ...
        public static PerfFormattedData_Counters_PerProcessorNetworkActivityCycles[] Retrieve(string remote,
        ...
        public static PerfFormattedData_Counters_PerProcessorNetworkActivityCycles[] Retrieve()
        {
        ...
        {
            var objectQuery =
                new ObjectQuery("SELECT * FROM Win32_PerfFormattedData_Counters_PerProcessorNetworkActivityCycles");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfFormattedData_Counters_PerProcessorNetworkActivityCycles>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_Counters_PerProcessorNetworkActivityCycles
                {
