...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_Counters_StorageSpacesWriteCache
    {
        ...
        public static PerfFormattedData_Counters_StorageSpacesWriteCache[] Retrieve(string remote, string username,
            string password)
        {
        ...
        public static PerfFormattedData_Counters_StorageSpacesWriteCache[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfFormattedData_Counters_StorageSpacesWriteCache[] Retrieve(ManagementScope managementScope)
        {
            ...
            var list = new List<PerfFormattedData_Counters_StorageSpacesWriteCache>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_Counters_StorageSpacesWriteCache
                {
