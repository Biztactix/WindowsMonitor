...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_DistributedRoutingTablePerf_DistributedRoutingTable
    {
        ...
        public static PerfFormattedData_DistributedRoutingTablePerf_DistributedRoutingTable[] Retrieve(string remote,
        ...
        public static PerfFormattedData_DistributedRoutingTablePerf_DistributedRoutingTable[] Retrieve()
        {
            ...
            ManagementScope managementScope)
        {
            var objectQuery =
                new ObjectQuery(
                    "SELECT * FROM Win32_PerfFormattedData_DistributedRoutingTablePerf_DistributedRoutingTable");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfFormattedData_DistributedRoutingTablePerf_DistributedRoutingTable>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_DistributedRoutingTablePerf_DistributedRoutingTable
                {
