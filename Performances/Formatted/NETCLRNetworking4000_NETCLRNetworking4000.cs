...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_NETCLRNetworking4000_NETCLRNetworking4000
    {
        ...
        public static PerfFormattedData_NETCLRNetworking4000_NETCLRNetworking4000[] Retrieve(string remote,
        ...
        public static PerfFormattedData_NETCLRNetworking4000_NETCLRNetworking4000[] Retrieve()
        {
        ...
        {
            var objectQuery =
                new ObjectQuery("SELECT * FROM Win32_PerfFormattedData_NETCLRNetworking4000_NETCLRNetworking4000");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfFormattedData_NETCLRNetworking4000_NETCLRNetworking4000>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_NETCLRNetworking4000_NETCLRNetworking4000
                {
