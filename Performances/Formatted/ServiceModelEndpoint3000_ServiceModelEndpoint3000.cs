...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_ServiceModelEndpoint3000_ServiceModelEndpoint3000
    {
        ...
        public static PerfFormattedData_ServiceModelEndpoint3000_ServiceModelEndpoint3000[] Retrieve(string remote,
        ...
        public static PerfFormattedData_ServiceModelEndpoint3000_ServiceModelEndpoint3000[] Retrieve()
        {
            ...
            ManagementScope managementScope)
        {
            var objectQuery =
                new ObjectQuery(
                    "SELECT * FROM Win32_PerfFormattedData_ServiceModelEndpoint3000_ServiceModelEndpoint3000");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfFormattedData_ServiceModelEndpoint3000_ServiceModelEndpoint3000>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_ServiceModelEndpoint3000_ServiceModelEndpoint3000
                {
