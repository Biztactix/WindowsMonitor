...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_AFDCounters_MicrosoftWinsockBSP
    {
        ...
        public static PerfFormattedData_AFDCounters_MicrosoftWinsockBSP[] Retrieve(string remote, string username,
            string password)
        {
        ...
        public static PerfFormattedData_AFDCounters_MicrosoftWinsockBSP[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfFormattedData_AFDCounters_MicrosoftWinsockBSP[] Retrieve(ManagementScope managementScope)
        {
            ...
            var list = new List<PerfFormattedData_AFDCounters_MicrosoftWinsockBSP>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_AFDCounters_MicrosoftWinsockBSP
                {
