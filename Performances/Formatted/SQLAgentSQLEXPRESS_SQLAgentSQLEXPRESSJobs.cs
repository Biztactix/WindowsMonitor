...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSJobs
    {
        ...
        public static PerfFormattedData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSJobs[] Retrieve(string remote,
        ...
        public static PerfFormattedData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSJobs[] Retrieve()
        {
        ...
        {
            var objectQuery =
                new ObjectQuery("SELECT * FROM Win32_PerfFormattedData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSJobs");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfFormattedData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSJobs>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSJobs
                {
