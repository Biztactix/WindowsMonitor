...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_Counters_EventTracingforWindowsSession
    {
        ...
        public static PerfFormattedData_Counters_EventTracingforWindowsSession[] Retrieve(string remote,
        ...
        public static PerfFormattedData_Counters_EventTracingforWindowsSession[] Retrieve()
        {
        ...
        {
            var objectQuery =
                new ObjectQuery("SELECT * FROM Win32_PerfFormattedData_Counters_EventTracingforWindowsSession");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfFormattedData_Counters_EventTracingforWindowsSession>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_Counters_EventTracingforWindowsSession
                {
