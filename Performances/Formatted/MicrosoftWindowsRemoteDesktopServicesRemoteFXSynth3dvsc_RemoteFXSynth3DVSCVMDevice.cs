...
namespace ComputerManagment
{
    ...
    /// </summary>
    public sealed class
        PerfFormattedData_MicrosoftWindowsRemoteDesktopServicesRemoteFXSynth3dvsc_RemoteFXSynth3DVSCVMDevice
    {
            ...
            Retrieve(ManagementScope managementScope)
        {
            var objectQuery =
                new ObjectQuery(
                    "SELECT * FROM Win32_PerfFormattedData_MicrosoftWindowsRemoteDesktopServicesRemoteFXSynth3dvsc_RemoteFXSynth3DVSCVMDevice");
                ...
                list.Add(
                    new
                        PerfFormattedData_MicrosoftWindowsRemoteDesktopServicesRemoteFXSynth3dvsc_RemoteFXSynth3DVSCVMDevice
                        {
                            ...
                            NumberofdisconnectedVMTchannels = (uint) managementObject
                                .Properties["NumberofdisconnectedVMTchannels"].Value,
                            ...
                            TotalnumberofcreatedVMTchannels = (uint) managementObject
                                .Properties["TotalnumberofcreatedVMTchannels"].Value
                        });
