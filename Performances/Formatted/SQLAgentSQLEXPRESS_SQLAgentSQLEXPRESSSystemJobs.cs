...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSSystemJobs
    {
        ...
        public static PerfFormattedData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSSystemJobs[] Retrieve(string remote,
        ...
        public static PerfFormattedData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSSystemJobs[] Retrieve()
        {
            ...
            ManagementScope managementScope)
        {
            var objectQuery =
                new ObjectQuery(
                    "SELECT * FROM Win32_PerfFormattedData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSSystemJobs");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfFormattedData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSSystemJobs>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSSystemJobs
                {
