...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_Counters_ThermalZoneInformation
    {
        ...
        public static PerfFormattedData_Counters_ThermalZoneInformation[] Retrieve(string remote, string username,
            string password)
        {
        ...
        public static PerfFormattedData_Counters_ThermalZoneInformation[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfFormattedData_Counters_ThermalZoneInformation[] Retrieve(ManagementScope managementScope)
        {
            ...
            var list = new List<PerfFormattedData_Counters_ThermalZoneInformation>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_Counters_ThermalZoneInformation
                {
