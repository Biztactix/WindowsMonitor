...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPCursors
    {
        ...
        public static PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPCursors[] Retrieve(string remote,
        ...
        public static PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPCursors[] Retrieve()
        {
            ...
            ManagementScope managementScope)
        {
            var objectQuery =
                new ObjectQuery(
                    "SELECT * FROM Win32_PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPCursors");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPCursors>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPCursors
                {
