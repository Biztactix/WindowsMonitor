...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPTransactions
    {
        ...
        public static PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPTransactions[] Retrieve(
            ...
            ManagementScope managementScope)
        {
            var objectQuery =
                new ObjectQuery(
                    "SELECT * FROM Win32_PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPTransactions");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPTransactions>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPTransactions
                {
