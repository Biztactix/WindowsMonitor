...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPStorage
    {
        ...
        public static PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPStorage[] Retrieve(string remote,
        ...
        public static PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPStorage[] Retrieve()
        {
            ...
            ManagementScope managementScope)
        {
            var objectQuery =
                new ObjectQuery(
                    "SELECT * FROM Win32_PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPStorage");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPStorage>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPStorage
                {
