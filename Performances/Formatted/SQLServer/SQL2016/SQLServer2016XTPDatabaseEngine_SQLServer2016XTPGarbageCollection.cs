...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPGarbageCollection
    {
        ...
        public static PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPGarbageCollection[] Retrieve(
            ...
            ManagementScope managementScope)
        {
            var objectQuery =
                new ObjectQuery(
                    "SELECT * FROM Win32_PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPGarbageCollection");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPGarbageCollection>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPGarbageCollection
                {
