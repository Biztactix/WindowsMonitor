...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_MSSQLSERVER_SQLServerBrokerDBMTransport
    {
        ...
        public static PerfFormattedData_MSSQLSERVER_SQLServerBrokerDBMTransport[] Retrieve(string remote,
        ...
        public static PerfFormattedData_MSSQLSERVER_SQLServerBrokerDBMTransport[] Retrieve()
        {
        ...
        {
            var objectQuery =
                new ObjectQuery("SELECT * FROM Win32_PerfFormattedData_MSSQLSERVER_SQLServerBrokerDBMTransport");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfFormattedData_MSSQLSERVER_SQLServerBrokerDBMTransport>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_MSSQLSERVER_SQLServerBrokerDBMTransport
                {
