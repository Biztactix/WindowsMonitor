...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_MSSQLSERVER_SQLServerThrottlSoftPartition_Costly
    {
        ...
        public static PerfFormattedData_MSSQLSERVER_SQLServerThrottlSoftPartition_Costly[] Retrieve(string remote,
        ...
        public static PerfFormattedData_MSSQLSERVER_SQLServerThrottlSoftPartition_Costly[] Retrieve()
        {
            ...
            ManagementScope managementScope)
        {
            var objectQuery =
                new ObjectQuery(
                    "SELECT * FROM Win32_PerfFormattedData_MSSQLSERVER_SQLServerThrottlSoftPartition_Costly");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfFormattedData_MSSQLSERVER_SQLServerThrottlSoftPartition_Costly>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_MSSQLSERVER_SQLServerThrottlSoftPartition_Costly
                {
