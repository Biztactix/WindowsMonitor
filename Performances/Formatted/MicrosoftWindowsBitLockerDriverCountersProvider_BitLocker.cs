...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_MicrosoftWindowsBitLockerDriverCountersProvider_BitLocker
    {
        ...
        public static PerfFormattedData_MicrosoftWindowsBitLockerDriverCountersProvider_BitLocker[] Retrieve(
            ...
            ManagementScope managementScope)
        {
            var objectQuery =
                new ObjectQuery(
                    "SELECT * FROM Win32_PerfFormattedData_MicrosoftWindowsBitLockerDriverCountersProvider_BitLocker");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfFormattedData_MicrosoftWindowsBitLockerDriverCountersProvider_BitLocker>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_MicrosoftWindowsBitLockerDriverCountersProvider_BitLocker
                {
