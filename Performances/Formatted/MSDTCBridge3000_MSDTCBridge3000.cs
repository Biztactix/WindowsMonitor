...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_MSDTCBridge3000_MSDTCBridge3000
    {
        ...
        public static PerfFormattedData_MSDTCBridge3000_MSDTCBridge3000[] Retrieve(string remote, string username,
            string password)
        {
        ...
        public static PerfFormattedData_MSDTCBridge3000_MSDTCBridge3000[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfFormattedData_MSDTCBridge3000_MSDTCBridge3000[] Retrieve(ManagementScope managementScope)
        {
            ...
            var list = new List<PerfFormattedData_MSDTCBridge3000_MSDTCBridge3000>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_MSDTCBridge3000_MSDTCBridge3000
                {
