...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_UGatherer_SearchGathererProjects
    {
        ...
        public static PerfFormattedData_UGatherer_SearchGathererProjects[] Retrieve(string remote, string username,
            string password)
        {
        ...
        public static PerfFormattedData_UGatherer_SearchGathererProjects[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfFormattedData_UGatherer_SearchGathererProjects[] Retrieve(ManagementScope managementScope)
        {
            ...
            var list = new List<PerfFormattedData_UGatherer_SearchGathererProjects>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_UGatherer_SearchGathererProjects
                {
