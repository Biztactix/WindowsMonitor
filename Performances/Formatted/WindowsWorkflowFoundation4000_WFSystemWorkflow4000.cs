...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000
    {
        ...
        public static PerfFormattedData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000[] Retrieve(string remote,
        ...
        public static PerfFormattedData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000[] Retrieve()
        {
            ...
            ManagementScope managementScope)
        {
            ...
            var list = new List<PerfFormattedData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000
                {
