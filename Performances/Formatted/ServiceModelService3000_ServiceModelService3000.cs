...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfFormattedData_ServiceModelService3000_ServiceModelService3000
    {
        ...
        public static PerfFormattedData_ServiceModelService3000_ServiceModelService3000[] Retrieve(string remote,
        ...
        public static PerfFormattedData_ServiceModelService3000_ServiceModelService3000[] Retrieve()
        {
            ...
            ManagementScope managementScope)
        {
            var objectQuery =
                new ObjectQuery(
                    "SELECT * FROM Win32_PerfFormattedData_ServiceModelService3000_ServiceModelService3000");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfFormattedData_ServiceModelService3000_ServiceModelService3000>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfFormattedData_ServiceModelService3000_ServiceModelService3000
                {
