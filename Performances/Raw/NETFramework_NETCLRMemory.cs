...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_NETFramework_NETCLRMemory
    {
        ...
        public uint PercentTimeinGC_Base { get; private set; }
        ...
        public static PerfRawData_NETFramework_NETCLRMemory[] Retrieve(string remote, string username, string password)
        {
        ...
        public static PerfRawData_NETFramework_NETCLRMemory[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_NETFramework_NETCLRMemory[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_NETFramework_NETCLRMemory");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_NETFramework_NETCLRMemory>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_NETFramework_NETCLRMemory
                {
                    ...
                    PercentTimeinGC_Base = (uint) managementObject.Properties["PercentTimeinGC_Base"].Value,
