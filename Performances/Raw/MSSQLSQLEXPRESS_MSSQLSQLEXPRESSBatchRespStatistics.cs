...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSBatchRespStatistics
    {
        ...
        public static PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSBatchRespStatistics[] Retrieve(string remote,
        ...
        public static PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSBatchRespStatistics[] Retrieve()
        {
        ...
        {
            var objectQuery =
                new ObjectQuery("SELECT * FROM Win32_PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSBatchRespStatistics");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSBatchRespStatistics>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSBatchRespStatistics
                {
