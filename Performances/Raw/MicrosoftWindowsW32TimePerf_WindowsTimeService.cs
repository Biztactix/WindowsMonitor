...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_MicrosoftWindowsW32TimePerf_WindowsTimeService
    {
        ...
        public static PerfRawData_MicrosoftWindowsW32TimePerf_WindowsTimeService[] Retrieve(string remote,
        ...
        public static PerfRawData_MicrosoftWindowsW32TimePerf_WindowsTimeService[] Retrieve()
        {
        ...
        {
            var objectQuery =
                new ObjectQuery("SELECT * FROM Win32_PerfRawData_MicrosoftWindowsW32TimePerf_WindowsTimeService");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_MicrosoftWindowsW32TimePerf_WindowsTimeService>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_MicrosoftWindowsW32TimePerf_WindowsTimeService
                {
