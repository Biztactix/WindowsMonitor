...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_ESENT_Database
    {
        ...
        public static PerfRawData_ESENT_Database[] Retrieve(string remote, string username, string password)
        {
        ...
        public static PerfRawData_ESENT_Database[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_ESENT_Database[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_ESENT_Database");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_ESENT_Database>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_ESENT_Database
                {
                    ...
                    DatabaseCachePercentDehydrated_Base =
                        (uint) managementObject.Properties["DatabaseCachePercentDehydrated_Base"].Value,
