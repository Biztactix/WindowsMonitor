...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_NETMemoryCache40_NETMemoryCache40
    {
        ...
        public static PerfRawData_NETMemoryCache40_NETMemoryCache40[] Retrieve(string remote, string username,
            string password)
        {
        ...
        public static PerfRawData_NETMemoryCache40_NETMemoryCache40[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_NETMemoryCache40_NETMemoryCache40[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_NETMemoryCache40_NETMemoryCache40");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_NETMemoryCache40_NETMemoryCache40>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_NETMemoryCache40_NETMemoryCache40
                {
                    ...
                    CacheHitRatio_Base = (uint) managementObject.Properties["CacheHitRatio_Base"].Value,
