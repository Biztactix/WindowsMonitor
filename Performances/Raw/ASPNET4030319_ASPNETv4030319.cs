...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_ASPNET4030319_ASPNETv4030319
    {
        ...
        public static PerfRawData_ASPNET4030319_ASPNETv4030319[] Retrieve(string remote, string username,
            string password)
        {
        ...
        public static PerfRawData_ASPNET4030319_ASPNETv4030319[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_ASPNET4030319_ASPNETv4030319[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_ASPNET4030319_ASPNETv4030319");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_ASPNET4030319_ASPNETv4030319>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_ASPNET4030319_ASPNETv4030319
                {
                    ...
                    RequestsInNativeQueue = (uint) managementObject.Properties["RequestsInNativeQueue"].Value,
