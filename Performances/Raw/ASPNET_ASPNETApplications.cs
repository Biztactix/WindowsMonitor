...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_ASPNET_ASPNETApplications
    {
        ...
        public static PerfRawData_ASPNET_ASPNETApplications[] Retrieve(string remote, string username, string password)
        {
        ...
        public static PerfRawData_ASPNET_ASPNETApplications[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_ASPNET_ASPNETApplications[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_ASPNET_ASPNETApplications");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_ASPNET_ASPNETApplications>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_ASPNET_ASPNETApplications
                {
