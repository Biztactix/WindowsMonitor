...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_NETDataProviderforOracle_NETDataProviderforOracle
    {
        ...
        public static PerfRawData_NETDataProviderforOracle_NETDataProviderforOracle[] Retrieve(string remote,
        ...
        public static PerfRawData_NETDataProviderforOracle_NETDataProviderforOracle[] Retrieve()
        {
        ...
        {
            var objectQuery =
                new ObjectQuery("SELECT * FROM Win32_PerfRawData_NETDataProviderforOracle_NETDataProviderforOracle");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_NETDataProviderforOracle_NETDataProviderforOracle>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_NETDataProviderforOracle_NETDataProviderforOracle
                {
