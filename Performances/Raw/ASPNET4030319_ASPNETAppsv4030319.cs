...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_ASPNET4030319_ASPNETAppsv4030319
    {
        ...
        public static PerfRawData_ASPNET4030319_ASPNETAppsv4030319[] Retrieve(string remote, string username,
            string password)
        {
        ...
        public static PerfRawData_ASPNET4030319_ASPNETAppsv4030319[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_ASPNET4030319_ASPNETAppsv4030319[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_ASPNET4030319_ASPNETAppsv4030319");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_ASPNET4030319_ASPNETAppsv4030319>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_ASPNET4030319_ASPNETAppsv4030319
                {
                    ...
                    ManagedMemoryUsedestimated = (uint) managementObject.Properties["ManagedMemoryUsedestimated"].Value,
                    ...
                    PercentManagedProcessorTimeestimated = (uint) managementObject
                        .Properties["PercentManagedProcessorTimeestimated"].Value,
                    PercentManagedProcessorTimeestimated_Base = (uint) managementObject
                        .Properties["PercentManagedProcessorTimeestimated_Base"].Value,
                    ...
                    RequestBytesInTotalWebSockets = (uint) managementObject.Properties["RequestBytesInTotalWebSockets"]
                        .Value,
                    RequestBytesOutTotal = (uint) managementObject.Properties["RequestBytesOutTotal"].Value,
                    RequestBytesOutTotalWebSockets =
                        (uint) managementObject.Properties["RequestBytesOutTotalWebSockets"].Value,
                    ...
                    RequestsExecutingWebSockets = (uint) managementObject.Properties["RequestsExecutingWebSockets"]
                        .Value,
                    RequestsFailed = (uint) managementObject.Properties["RequestsFailed"].Value,
                    RequestsFailedWebSockets = (uint) managementObject.Properties["RequestsFailedWebSockets"].Value,
                    ...
                    RequestsSucceededWebSockets = (uint) managementObject.Properties["RequestsSucceededWebSockets"]
                        .Value,
                    ...
                    RequestsTotalWebSockets = (uint) managementObject.Properties["RequestsTotalWebSockets"].Value,
