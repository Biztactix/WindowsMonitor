...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_WSearchIdxPi_SearchIndexer
    {
        ...
        public static PerfRawData_WSearchIdxPi_SearchIndexer[] Retrieve(string remote, string username, string password)
        {
        ...
        public static PerfRawData_WSearchIdxPi_SearchIndexer[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_WSearchIdxPi_SearchIndexer[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_WSearchIdxPi_SearchIndexer");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_WSearchIdxPi_SearchIndexer>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_WSearchIdxPi_SearchIndexer
                {
