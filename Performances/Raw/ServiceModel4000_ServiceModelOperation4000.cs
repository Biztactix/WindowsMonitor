...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_ServiceModel4000_ServiceModelOperation4000
    {
        ...
        public static PerfRawData_ServiceModel4000_ServiceModelOperation4000[] Retrieve(string remote, string username,
            string password)
        {
        ...
        public static PerfRawData_ServiceModel4000_ServiceModelOperation4000[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_ServiceModel4000_ServiceModelOperation4000[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery =
                new ObjectQuery("SELECT * FROM Win32_PerfRawData_ServiceModel4000_ServiceModelOperation4000");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_ServiceModel4000_ServiceModelOperation4000>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_ServiceModel4000_ServiceModelOperation4000
                {
