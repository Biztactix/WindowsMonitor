...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_HvStats_HyperVHypervisorLogicalProcessor
    {
        ...
        public static PerfRawData_HvStats_HyperVHypervisorLogicalProcessor[] Retrieve(string remote, string username,
            string password)
        {
        ...
        public static PerfRawData_HvStats_HyperVHypervisorLogicalProcessor[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_HvStats_HyperVHypervisorLogicalProcessor[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery =
                new ObjectQuery("SELECT * FROM Win32_PerfRawData_HvStats_HyperVHypervisorLogicalProcessor");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_HvStats_HyperVHypervisorLogicalProcessor>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_HvStats_HyperVHypervisorLogicalProcessor
                {
                    ...
                    PercentC1Time_Base = (ulong) managementObject.Properties["PercentC1Time_Base"].Value,
                    PercentC2Time = (ulong) managementObject.Properties["PercentC2Time"].Value,
                    PercentC2Time_Base = (ulong) managementObject.Properties["PercentC2Time_Base"].Value,
                    PercentC3Time = (ulong) managementObject.Properties["PercentC3Time"].Value,
                    PercentC3Time_Base = (ulong) managementObject.Properties["PercentC3Time_Base"].Value,
