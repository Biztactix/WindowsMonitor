...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_MSSQLSERVER_SQLServerDatabases
    {
        ...
        public static PerfRawData_MSSQLSERVER_SQLServerDatabases[] Retrieve(string remote, string username,
            string password)
        {
        ...
        public static PerfRawData_MSSQLSERVER_SQLServerDatabases[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_MSSQLSERVER_SQLServerDatabases[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_MSSQLSERVER_SQLServerDatabases");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_MSSQLSERVER_SQLServerDatabases>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_MSSQLSERVER_SQLServerDatabases
                {
                    ActiveTransactions = (ulong) managementObject.Properties["ActiveTransactions"].Value,
                    AvgDistFromEOLLPRequest = (ulong) managementObject.Properties["AvgDistFromEOLLPRequest"].Value,
                    AvgDistFromEOLLPRequest_Base = (uint) managementObject.Properties["AvgDistFromEOLLPRequest_Base"]
                        .Value,
                    ...
                    LogPoolHashDeletesPersec = (ulong) managementObject.Properties["LogPoolHashDeletesPersec"].Value,
                    LogPoolHashInsertsPersec = (ulong) managementObject.Properties["LogPoolHashInsertsPersec"].Value,
                    LogPoolInvalidHashEntryPersec =
                        (ulong) managementObject.Properties["LogPoolInvalidHashEntryPersec"].Value,
                    LogPoolLogScanPushesPersec =
                        (ulong) managementObject.Properties["LogPoolLogScanPushesPersec"].Value,
                    LogPoolLogWriterPushesPersec = (ulong) managementObject.Properties["LogPoolLogWriterPushesPersec"]
                        .Value,
                    LogPoolPushEmptyFreePoolPersec =
                        (ulong) managementObject.Properties["LogPoolPushEmptyFreePoolPersec"].Value,
                    LogPoolPushLowMemoryPersec =
                        (ulong) managementObject.Properties["LogPoolPushLowMemoryPersec"].Value,
                    LogPoolPushNoFreeBufferPersec =
                        (ulong) managementObject.Properties["LogPoolPushNoFreeBufferPersec"].Value,
                    LogPoolReqBehindTruncPersec = (ulong) managementObject.Properties["LogPoolReqBehindTruncPersec"]
                        .Value,
                    LogPoolRequestsOldVLFPersec = (ulong) managementObject.Properties["LogPoolRequestsOldVLFPersec"]
                        .Value,
                    LogPoolRequestsPersec = (ulong) managementObject.Properties["LogPoolRequestsPersec"].Value,
                    LogPoolTotalActiveLogSize = (ulong) managementObject.Properties["LogPoolTotalActiveLogSize"].Value,
                    LogPoolTotalSharedPoolSize =
                        (ulong) managementObject.Properties["LogPoolTotalSharedPoolSize"].Value,
                    ...
                    XTPControllerDLCLatencyPerFetch =
                        (ulong) managementObject.Properties["XTPControllerDLCLatencyPerFetch"].Value,
                    XTPControllerDLCLatencyPerFetch_Base = (uint) managementObject
                        .Properties["XTPControllerDLCLatencyPerFetch_Base"].Value,
                    XTPControllerDLCPeakLatency = (ulong) managementObject.Properties["XTPControllerDLCPeakLatency"]
                        .Value,
                    XTPControllerLogProcessedPersec =
                        (ulong) managementObject.Properties["XTPControllerLogProcessedPersec"].Value,
