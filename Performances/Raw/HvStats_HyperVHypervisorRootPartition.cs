...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_HvStats_HyperVHypervisorRootPartition
    {
        ...
        public ulong IOTLBFlushCost_Base { get; private set; }
        ...
        public static PerfRawData_HvStats_HyperVHypervisorRootPartition[] Retrieve(string remote, string username,
            string password)
        {
        ...
        public static PerfRawData_HvStats_HyperVHypervisorRootPartition[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_HvStats_HyperVHypervisorRootPartition[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_HvStats_HyperVHypervisorRootPartition");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_HvStats_HyperVHypervisorRootPartition>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_HvStats_HyperVHypervisorRootPartition
                {
                    ...
                    IOTLBFlushCost_Base = (ulong) managementObject.Properties["IOTLBFlushCost_Base"].Value,
