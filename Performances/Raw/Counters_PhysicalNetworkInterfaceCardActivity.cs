...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_Counters_PhysicalNetworkInterfaceCardActivity
    {
        ...
        public static PerfRawData_Counters_PhysicalNetworkInterfaceCardActivity[] Retrieve(string remote,
        ...
        public static PerfRawData_Counters_PhysicalNetworkInterfaceCardActivity[] Retrieve()
        {
        ...
        {
            var objectQuery =
                new ObjectQuery("SELECT * FROM Win32_PerfRawData_Counters_PhysicalNetworkInterfaceCardActivity");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_Counters_PhysicalNetworkInterfaceCardActivity>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_Counters_PhysicalNetworkInterfaceCardActivity
                {
                    ...
                    PercentTimeSuspendedLifetime_Base =
                        (ulong) managementObject.Properties["PercentTimeSuspendedLifetime_Base"].Value,
