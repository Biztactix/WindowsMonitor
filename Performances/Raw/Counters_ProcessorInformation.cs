...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_Counters_ProcessorInformation
    {
        ...
        public static PerfRawData_Counters_ProcessorInformation[] Retrieve(string remote, string username,
            string password)
        {
        ...
        public static PerfRawData_Counters_ProcessorInformation[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_Counters_ProcessorInformation[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_Counters_ProcessorInformation");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_Counters_ProcessorInformation>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_Counters_ProcessorInformation
                {
                    AverageIdleTime = (ulong) managementObject.Properties["AverageIdleTime"].Value,
                    AverageIdleTime_Base = (ulong) managementObject.Properties["AverageIdleTime_Base"].Value,
                    ...
                    PercentPrivilegedUtility_Base = (uint) managementObject.Properties["PercentPrivilegedUtility_Base"]
                        .Value,
                    ...
                    PercentProcessorPerformance_Base =
                        (uint) managementObject.Properties["PercentProcessorPerformance_Base"].Value,
                    ...
                    PercentProcessorUtility_Base = (uint) managementObject.Properties["PercentProcessorUtility_Base"]
                        .Value,
