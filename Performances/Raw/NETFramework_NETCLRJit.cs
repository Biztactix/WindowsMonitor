...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_NETFramework_NETCLRJit
    {
        ...
        public static PerfRawData_NETFramework_NETCLRJit[] Retrieve(string remote, string username, string password)
        {
        ...
        public static PerfRawData_NETFramework_NETCLRJit[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_NETFramework_NETCLRJit[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_NETFramework_NETCLRJit");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_NETFramework_NETCLRJit>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_NETFramework_NETCLRJit
                {
                    ...
                    PercentTimeinJit_Base = (uint) managementObject.Properties["PercentTimeinJit_Base"].Value,
