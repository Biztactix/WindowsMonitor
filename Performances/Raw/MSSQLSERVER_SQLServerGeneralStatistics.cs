...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_MSSQLSERVER_SQLServerGeneralStatistics
    {
        ...
        public static PerfRawData_MSSQLSERVER_SQLServerGeneralStatistics[] Retrieve(string remote, string username,
            string password)
        {
        ...
        public static PerfRawData_MSSQLSERVER_SQLServerGeneralStatistics[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_MSSQLSERVER_SQLServerGeneralStatistics[] Retrieve(ManagementScope managementScope)
        {
            ...
            var list = new List<PerfRawData_MSSQLSERVER_SQLServerGeneralStatistics>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_MSSQLSERVER_SQLServerGeneralStatistics
                {
