...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_Counters_PerProcessorNetworkInterfaceCardActivity
    {
        ...
        public static PerfRawData_Counters_PerProcessorNetworkInterfaceCardActivity[] Retrieve(string remote,
        ...
        public static PerfRawData_Counters_PerProcessorNetworkInterfaceCardActivity[] Retrieve()
        {
        ...
        {
            var objectQuery =
                new ObjectQuery("SELECT * FROM Win32_PerfRawData_Counters_PerProcessorNetworkInterfaceCardActivity");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_Counters_PerProcessorNetworkInterfaceCardActivity>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_Counters_PerProcessorNetworkInterfaceCardActivity
                {
