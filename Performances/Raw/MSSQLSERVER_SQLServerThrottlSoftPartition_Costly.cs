...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_MSSQLSERVER_SQLServerThrottlSoftPartition_Costly
    {
        ...
        public static PerfRawData_MSSQLSERVER_SQLServerThrottlSoftPartition_Costly[] Retrieve(string remote,
        ...
        public static PerfRawData_MSSQLSERVER_SQLServerThrottlSoftPartition_Costly[] Retrieve()
        {
        ...
        {
            var objectQuery =
                new ObjectQuery("SELECT * FROM Win32_PerfRawData_MSSQLSERVER_SQLServerThrottlSoftPartition_Costly");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_MSSQLSERVER_SQLServerThrottlSoftPartition_Costly>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_MSSQLSERVER_SQLServerThrottlSoftPartition_Costly
                {
