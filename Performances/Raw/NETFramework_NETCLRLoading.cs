...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_NETFramework_NETCLRLoading
    {
        ...
        public static PerfRawData_NETFramework_NETCLRLoading[] Retrieve(string remote, string username, string password)
        {
        ...
        public static PerfRawData_NETFramework_NETCLRLoading[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_NETFramework_NETCLRLoading[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_NETFramework_NETCLRLoading");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_NETFramework_NETCLRLoading>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_NETFramework_NETCLRLoading
                {
