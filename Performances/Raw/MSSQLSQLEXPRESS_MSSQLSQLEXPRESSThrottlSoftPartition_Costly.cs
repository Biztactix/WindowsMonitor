...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSThrottlSoftPartition_Costly
    {
        ...
        public static PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSThrottlSoftPartition_Costly[] Retrieve(string remote,
        ...
        public static PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSThrottlSoftPartition_Costly[] Retrieve()
        {
            ...
            ManagementScope managementScope)
        {
            var objectQuery =
                new ObjectQuery(
                    "SELECT * FROM Win32_PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSThrottlSoftPartition_Costly");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSThrottlSoftPartition_Costly>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSThrottlSoftPartition_Costly
                {
