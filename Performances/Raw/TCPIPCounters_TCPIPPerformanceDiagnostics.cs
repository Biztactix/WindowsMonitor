...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_TCPIPCounters_TCPIPPerformanceDiagnostics
    {
        ...
        public static PerfRawData_TCPIPCounters_TCPIPPerformanceDiagnostics[] Retrieve(string remote, string username,
            string password)
        {
        ...
        public static PerfRawData_TCPIPCounters_TCPIPPerformanceDiagnostics[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_TCPIPCounters_TCPIPPerformanceDiagnostics[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery =
            ...
            var list = new List<PerfRawData_TCPIPCounters_TCPIPPerformanceDiagnostics>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_TCPIPCounters_TCPIPPerformanceDiagnostics
                {
