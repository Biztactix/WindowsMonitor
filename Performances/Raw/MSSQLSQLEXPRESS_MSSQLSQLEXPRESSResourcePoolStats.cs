...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSResourcePoolStats
    {
        ...
        public static PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSResourcePoolStats[] Retrieve(string remote,
        ...
        public static PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSResourcePoolStats[] Retrieve()
        {
        ...
        {
            var objectQuery =
                new ObjectQuery("SELECT * FROM Win32_PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSResourcePoolStats");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSResourcePoolStats>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_MSSQLSQLEXPRESS_MSSQLSQLEXPRESSResourcePoolStats
                {
