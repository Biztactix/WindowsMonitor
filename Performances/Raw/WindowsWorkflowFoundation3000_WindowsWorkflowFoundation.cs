...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_WindowsWorkflowFoundation3000_WindowsWorkflowFoundation
    {
        ...
        public static PerfRawData_WindowsWorkflowFoundation3000_WindowsWorkflowFoundation[] Retrieve(string remote,
        ...
        public static PerfRawData_WindowsWorkflowFoundation3000_WindowsWorkflowFoundation[] Retrieve()
        {
            ...
            ManagementScope managementScope)
        {
            var objectQuery =
                new ObjectQuery(
                    "SELECT * FROM Win32_PerfRawData_WindowsWorkflowFoundation3000_WindowsWorkflowFoundation");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_WindowsWorkflowFoundation3000_WindowsWorkflowFoundation>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_WindowsWorkflowFoundation3000_WindowsWorkflowFoundation
                {
