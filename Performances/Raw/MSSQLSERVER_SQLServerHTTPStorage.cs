...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_MSSQLSERVER_SQLServerHTTPStorage
    {
        ...
        public static PerfRawData_MSSQLSERVER_SQLServerHTTPStorage[] Retrieve(string remote, string username,
            string password)
        {
        ...
        public static PerfRawData_MSSQLSERVER_SQLServerHTTPStorage[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_MSSQLSERVER_SQLServerHTTPStorage[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_MSSQLSERVER_SQLServerHTTPStorage");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_MSSQLSERVER_SQLServerHTTPStorage>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_MSSQLSERVER_SQLServerHTTPStorage
                {
                    ...
                    AvgmicrosecPerReadComp_Base = (uint) managementObject.Properties["AvgmicrosecPerReadComp_Base"]
                        .Value,
                    ...
                    AvgmicrosecPerWriteComp_Base = (uint) managementObject.Properties["AvgmicrosecPerWriteComp_Base"]
                        .Value,
