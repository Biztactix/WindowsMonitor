...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_DdmCounterProvider_RAS
    {
        ...
        public static PerfRawData_DdmCounterProvider_RAS[] Retrieve(string remote, string username, string password)
        {
        ...
        public static PerfRawData_DdmCounterProvider_RAS[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_DdmCounterProvider_RAS[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_DdmCounterProvider_RAS");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_DdmCounterProvider_RAS>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_DdmCounterProvider_RAS
                {
