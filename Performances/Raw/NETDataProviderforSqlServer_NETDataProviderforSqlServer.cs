...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_NETDataProviderforSqlServer_NETDataProviderforSqlServer
    {
        ...
        public static PerfRawData_NETDataProviderforSqlServer_NETDataProviderforSqlServer[] Retrieve(string remote,
        ...
        public static PerfRawData_NETDataProviderforSqlServer_NETDataProviderforSqlServer[] Retrieve()
        {
            ...
            ManagementScope managementScope)
        {
            var objectQuery =
                new ObjectQuery(
                    "SELECT * FROM Win32_PerfRawData_NETDataProviderforSqlServer_NETDataProviderforSqlServer");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_NETDataProviderforSqlServer_NETDataProviderforSqlServer>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_NETDataProviderforSqlServer_NETDataProviderforSqlServer
                {
