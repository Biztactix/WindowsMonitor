...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_FaxService_FaxService
    {
        ...
        public static PerfRawData_FaxService_FaxService[] Retrieve(string remote, string username, string password)
        {
        ...
        public static PerfRawData_FaxService_FaxService[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_FaxService_FaxService[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_FaxService_FaxService");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_FaxService_FaxService>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_FaxService_FaxService
                {
