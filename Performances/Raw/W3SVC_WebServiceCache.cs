...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_W3SVC_WebServiceCache
    {
        ...
        public static PerfRawData_W3SVC_WebServiceCache[] Retrieve(string remote, string username, string password)
        {
        ...
        public static PerfRawData_W3SVC_WebServiceCache[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_W3SVC_WebServiceCache[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_W3SVC_WebServiceCache");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_W3SVC_WebServiceCache>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_W3SVC_WebServiceCache
                {
                    ...
                    FileCacheHitsPercent_Base = (uint) managementObject.Properties["FileCacheHitsPercent_Base"].Value,
                    ...
                    KernelURICacheHitsPercent_Base =
                        (uint) managementObject.Properties["KernelURICacheHitsPercent_Base"].Value,
                    ...
                    MetadataCacheHitsPercent_Base = (uint) managementObject.Properties["MetadataCacheHitsPercent_Base"]
                        .Value,
                    ...
                    OutputCacheCurrentHitsPercent = (uint) managementObject.Properties["OutputCacheCurrentHitsPercent"]
                        .Value,
                    OutputCacheCurrentHitsPercent_Base =
                        (uint) managementObject.Properties["OutputCacheCurrentHitsPercent_Base"].Value,
                    ...
                    URICacheHitsPercent_Base = (uint) managementObject.Properties["URICacheHitsPercent_Base"].Value,
