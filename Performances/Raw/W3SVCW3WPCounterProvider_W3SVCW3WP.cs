...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_W3SVCW3WPCounterProvider_W3SVCW3WP
    {
        ...
        public uint Percent401HTTPResponseSent_Base { get; private set; }
        public uint Percent403HTTPResponseSent { get; private set; }
        public uint Percent403HTTPResponseSent_Base { get; private set; }
        public uint Percent404HTTPResponseSent { get; private set; }
        public uint Percent404HTTPResponseSent_Base { get; private set; }
        public uint Percent500HTTPResponseSent { get; private set; }
        public uint Percent500HTTPResponseSent_Base { get; private set; }
        ...
        public static PerfRawData_W3SVCW3WPCounterProvider_W3SVCW3WP[] Retrieve(string remote, string username,
            string password)
        {
        ...
        public static PerfRawData_W3SVCW3WPCounterProvider_W3SVCW3WP[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_W3SVCW3WPCounterProvider_W3SVCW3WP[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_W3SVCW3WPCounterProvider_W3SVCW3WP");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_W3SVCW3WPCounterProvider_W3SVCW3WP>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_W3SVCW3WPCounterProvider_W3SVCW3WP
                {
                    ...
                    Percent401HTTPResponseSent_Base =
                        (uint) managementObject.Properties["Percent401HTTPResponseSent_Base"].Value,
                    Percent403HTTPResponseSent = (uint) managementObject.Properties["Percent403HTTPResponseSent"].Value,
                    Percent403HTTPResponseSent_Base =
                        (uint) managementObject.Properties["Percent403HTTPResponseSent_Base"].Value,
                    Percent404HTTPResponseSent = (uint) managementObject.Properties["Percent404HTTPResponseSent"].Value,
                    Percent404HTTPResponseSent_Base =
                        (uint) managementObject.Properties["Percent404HTTPResponseSent_Base"].Value,
                    Percent500HTTPResponseSent = (uint) managementObject.Properties["Percent500HTTPResponseSent"].Value,
                    Percent500HTTPResponseSent_Base =
                        (uint) managementObject.Properties["Percent500HTTPResponseSent_Base"].Value,
