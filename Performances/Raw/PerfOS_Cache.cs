...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_PerfOS_Cache
    {
        ...
        public uint CopyReadHitsPercent_Base { get; private set; }
        ...
        public uint DataMapHitsPercent_Base { get; private set; }
        public uint DataMapPinsPersec { get; private set; }
        public uint DataMapPinsPersec_Base { get; private set; }
        ...
        public uint MDLReadHitsPercent_Base { get; private set; }
        public uint MDLReadsPersec { get; private set; }
        public string Name { get; private set; }
        public uint PinReadHitsPercent { get; private set; }
        public uint PinReadHitsPercent_Base { get; private set; }
        ...
        public static PerfRawData_PerfOS_Cache[] Retrieve(string remote, string username, string password)
        {
        ...
        public static PerfRawData_PerfOS_Cache[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_PerfOS_Cache[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_PerfOS_Cache");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_PerfOS_Cache>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_PerfOS_Cache
                {
                    ...
                    CopyReadHitsPercent_Base = (uint) managementObject.Properties["CopyReadHitsPercent_Base"].Value,
                    ...
                    DataMapHitsPercent_Base = (uint) managementObject.Properties["DataMapHitsPercent_Base"].Value,
                    DataMapPinsPersec = (uint) managementObject.Properties["DataMapPinsPersec"].Value,
                    DataMapPinsPersec_Base = (uint) managementObject.Properties["DataMapPinsPersec_Base"].Value,
                    ...
                    MDLReadHitsPercent_Base = (uint) managementObject.Properties["MDLReadHitsPercent_Base"].Value,
                    ...
                    PinReadHitsPercent_Base = (uint) managementObject.Properties["PinReadHitsPercent_Base"].Value,
