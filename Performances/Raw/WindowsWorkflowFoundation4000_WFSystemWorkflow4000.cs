...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000
    {
        ...
        public static PerfRawData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000[] Retrieve(string remote,
        ...
        public static PerfRawData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000[] Retrieve()
        {
        ...
        {
            var objectQuery =
                new ObjectQuery("SELECT * FROM Win32_PerfRawData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000
                {
