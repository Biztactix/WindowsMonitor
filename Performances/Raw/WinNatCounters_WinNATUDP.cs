...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_WinNatCounters_WinNATUDP
    {
        ...
        public static PerfRawData_WinNatCounters_WinNATUDP[] Retrieve(string remote, string username, string password)
        {
        ...
        public static PerfRawData_WinNatCounters_WinNATUDP[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_WinNatCounters_WinNATUDP[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_WinNatCounters_WinNATUDP");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_WinNatCounters_WinNATUDP>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_WinNatCounters_WinNATUDP
                {
