...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_ServiceModelService3000_ServiceModelService3000
    {
        ...
        public static PerfRawData_ServiceModelService3000_ServiceModelService3000[] Retrieve(string remote,
        ...
        public static PerfRawData_ServiceModelService3000_ServiceModelService3000[] Retrieve()
        {
        ...
        {
            var objectQuery =
                new ObjectQuery("SELECT * FROM Win32_PerfRawData_ServiceModelService3000_ServiceModelService3000");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_ServiceModelService3000_ServiceModelService3000>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_ServiceModelService3000_ServiceModelService3000
                {
