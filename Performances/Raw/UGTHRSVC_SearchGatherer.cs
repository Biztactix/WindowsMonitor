...
namespace ComputerManagment
{
    /// <summary>
    /// </summary>
    public sealed class PerfRawData_UGTHRSVC_SearchGatherer
    {
        ...
        public static PerfRawData_UGTHRSVC_SearchGatherer[] Retrieve(string remote, string username, string password)
        {
        ...
        public static PerfRawData_UGTHRSVC_SearchGatherer[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static PerfRawData_UGTHRSVC_SearchGatherer[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_UGTHRSVC_SearchGatherer");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<PerfRawData_UGTHRSVC_SearchGatherer>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new PerfRawData_UGTHRSVC_SearchGatherer
                {
