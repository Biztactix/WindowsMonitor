...
namespace ComputerManagment
{
    ...
    public sealed class Group
    {
        ...
        public static Group[] Retrieve(string remote, string username, string password)
        {
        ...
        public static Group[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static Group[] Retrieve(ManagementScope managementScope)
        {
