...
namespace ComputerManagment
{
    ...
    public sealed class SystemAccount
    {
        ...
        public static SystemAccount[] Retrieve(string remote, string username, string password)
        {
        ...
        public static SystemAccount[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static SystemAccount[] Retrieve(ManagementScope managementScope)
        {
