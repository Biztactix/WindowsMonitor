...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class StatusMediaSpecificIndicationEx
    {
        ...
        public static IEnumerable<StatusMediaSpecificIndicationEx> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<StatusMediaSpecificIndicationEx> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<StatusMediaSpecificIndicationEx> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new StatusMediaSpecificIndicationEx
                {
