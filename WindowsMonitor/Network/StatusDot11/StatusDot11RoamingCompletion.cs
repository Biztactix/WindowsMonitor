...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class StatusDot11RoamingCompletion
    {
        ...
        public static IEnumerable<StatusDot11RoamingCompletion> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<StatusDot11RoamingCompletion> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<StatusDot11RoamingCompletion> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new StatusDot11RoamingCompletion
                {
