...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class StatusDot11MpduMaxLengthChange
    {
        ...
        public static IEnumerable<StatusDot11MpduMaxLengthChange> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<StatusDot11MpduMaxLengthChange> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<StatusDot11MpduMaxLengthChange> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new StatusDot11MpduMaxLengthChange
                {
