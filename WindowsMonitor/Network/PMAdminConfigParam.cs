...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class PmAdminConfigParam
    {
        ...
        public static IEnumerable<PmAdminConfigParam> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<PmAdminConfigParam> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<PmAdminConfigParam> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new PmAdminConfigParam
                {
