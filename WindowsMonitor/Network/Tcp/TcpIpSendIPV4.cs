...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class TcpIpSendIpv4
    {
        ...
        public static IEnumerable<TcpIpSendIpv4> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<TcpIpSendIpv4> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<TcpIpSendIpv4> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new TcpIpSendIpv4
                {
