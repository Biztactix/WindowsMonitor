...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class TcpIpTypeGroup3
    {
        ...
        public static IEnumerable<TcpIpTypeGroup3> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<TcpIpTypeGroup3> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<TcpIpTypeGroup3> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new TcpIpTypeGroup3
                {
