...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class TcpIpTypeGroup2
    {
        ...
        public static IEnumerable<TcpIpTypeGroup2> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<TcpIpTypeGroup2> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<TcpIpTypeGroup2> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new TcpIpTypeGroup2
                {
