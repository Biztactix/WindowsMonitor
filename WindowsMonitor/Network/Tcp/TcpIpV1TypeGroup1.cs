...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class TcpIpV1TypeGroup1
    {
        ...
        public static IEnumerable<TcpIpV1TypeGroup1> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<TcpIpV1TypeGroup1> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<TcpIpV1TypeGroup1> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new TcpIpV1TypeGroup1
                {
