...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class ReceiveQueueInfoArray
    {
        ...
        public static IEnumerable<ReceiveQueueInfoArray> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<ReceiveQueueInfoArray> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<ReceiveQueueInfoArray> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new ReceiveQueueInfoArray
                {
