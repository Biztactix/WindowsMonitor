...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MediaInUse
    {
        ...
        public static IEnumerable<MediaInUse> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MediaInUse> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MediaInUse> Retrieve(ManagementScope managementScope)
        {
