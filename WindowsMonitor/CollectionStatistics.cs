...
namespace WindowsMonitor.Win32
{
    ...
    public sealed class CollectionStatistics
    {
        ...
        public static IEnumerable<CollectionStatistics> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<CollectionStatistics> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_CollectionStatistics");
