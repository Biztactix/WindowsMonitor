...
namespace WindowsMonitor.Win32.Performance.Raw.HyperVisor
{
    /// <summary>
    /// </summary>
    public sealed class HvStatsHyperVHypervisorRootVirtualProcessor
    {
		...
		public ulong ControlRegisterAccessesCostBase { get; private set; }
		...
		public ulong ControlRegisterAccessesForwardingCostBase { get; private set; }
		public ulong ControlRegisterAccessesPersec { get; private set; }
		public ulong CpuidInstructionsCost { get; private set; }
		public ulong CpuidInstructionsCostBase { get; private set; }
		...
		public ulong CpuidInstructionsForwardingCostBase { get; private set; }
		public ulong CpuidInstructionsPersec { get; private set; }
		public ulong CpuWaitTimePerDispatch { get; private set; }
		public ulong CpuWaitTimePerDispatchBase { get; private set; }
		public ulong DebugRegisterAccessesCost { get; private set; }
		public ulong DebugRegisterAccessesCostBase { get; private set; }
		...
		public ulong DebugRegisterAccessesForwardingCostBase { get; private set; }
		public ulong DebugRegisterAccessesPersec { get; private set; }
		public string Description { get; private set; }
		public ulong EmulatedInstructionsCost { get; private set; }
		public ulong EmulatedInstructionsCostBase { get; private set; }
		...
		public ulong EmulatedInstructionsForwardingCostBase { get; private set; }
		...
		public ulong ExternalInterruptsCostBase { get; private set; }
		...
		public ulong GlobalIotlbFlushCostBase { get; private set; }
		...
		public ulong InvEptAllContextInstructionEmulationCostBase { get; private set; }
		...
		public ulong InvEptSingleContextInstructionEmulationCostBase { get; private set; }
		...
		public ulong InvVpidAllContextInstructionEmulationCostBase { get; private set; }
		...
		public ulong InvVpidSingleAddressInstructionEmulationCostBase { get; private set; }
		...
		public ulong InvVpidSingleContextInstructionEmulationCostBase { get; private set; }
		public ulong IoInstructionsCost { get; private set; }
		public ulong IoInstructionsCostBase { get; private set; }
		public ulong IoInstructionsForwardedPersec { get; private set; }
		public ulong IoInstructionsForwardingCost { get; private set; }
		public ulong IoInstructionsForwardingCostBase { get; private set; }
		...
		public ulong LocalIotlbFlushCostBase { get; private set; }
		...
		public ulong NestedVmEntriesCostBase { get; private set; }
		...
		public ulong PageFaultInterceptsCostBase { get; private set; }
		...
		public ulong PageFaultInterceptsForwardingCostBase { get; private set; }
		public ulong PageFaultInterceptsPersec { get; private set; }
		public ulong PageInvalidationsCost { get; private set; }
		public ulong PageInvalidationsCostBase { get; private set; }
		...
		public ulong PageInvalidationsForwardingCostBase { get; private set; }
		...
		public ulong PendingInterruptsCostBase { get; private set; }
		...
		public ulong PendingInterruptsForwardingCostBase { get; private set; }
		...
		public ulong PercentRemoteRunTimeBase { get; private set; }
		...
		public ulong TotalInterceptsCostBase { get; private set; }
		...
		public ulong TotalVirtualizationInstructionsEmulationCostBase { get; private set; }
		...
		public ulong VmclearInstructionEmulationCostBase { get; private set; }
		...
		public ulong VmptrldInstructionEmulationCostBase { get; private set; }
		...
		public ulong VmptrstInstructionEmulationCostBase { get; private set; }
		public ulong VmreadEmulationInterceptsPersec { get; private set; }
		public ulong VmreadInstructionEmulationCost { get; private set; }
		public ulong VmreadInstructionEmulationCostBase { get; private set; }
		...
		public ulong VmwriteInstructionEmulationCostBase { get; private set; }
		public ulong VmxoffEmulationInterceptsPersec { get; private set; }
		public ulong VmxoffInstructionEmulationCost { get; private set; }
		public ulong VmxoffInstructionEmulationCostBase { get; private set; }
		public ulong VmxonEmulationInterceptsPersec { get; private set; }
		public ulong VmxonInstructionEmulationCost { get; private set; }
		public ulong VmxonInstructionEmulationCostBase { get; private set; }

        public static IEnumerable<HvStatsHyperVHypervisorRootVirtualProcessor> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<HvStatsHyperVHypervisorRootVirtualProcessor> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<HvStatsHyperVHypervisorRootVirtualProcessor> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_HvStats_HyperVHypervisorRootVirtualProcessor");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            foreach (ManagementObject managementObject in objectCollection)
                yield return new HvStatsHyperVHypervisorRootVirtualProcessor
                {
		 ...
		 ControlRegisterAccessesCostBase = (ulong) (managementObject.Properties["ControlRegisterAccessesCost_Base"]?.Value ?? default(ulong)),
		 ...
		 ControlRegisterAccessesForwardingCostBase = (ulong) (managementObject.Properties["ControlRegisterAccessesForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 CpuidInstructionsCostBase = (ulong) (managementObject.Properties["CPUIDInstructionsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 CpuidInstructionsForwardingCostBase = (ulong) (managementObject.Properties["CPUIDInstructionsForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 CpuWaitTimePerDispatchBase = (ulong) (managementObject.Properties["CPUWaitTimePerDispatch_Base"]?.Value ?? default(ulong)),
		 DebugRegisterAccessesCost = (ulong) (managementObject.Properties["DebugRegisterAccessesCost"]?.Value ?? default(ulong)),
		 DebugRegisterAccessesCostBase = (ulong) (managementObject.Properties["DebugRegisterAccessesCost_Base"]?.Value ?? default(ulong)),
		 ...
		 DebugRegisterAccessesForwardingCostBase = (ulong) (managementObject.Properties["DebugRegisterAccessesForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 EmulatedInstructionsCostBase = (ulong) (managementObject.Properties["EmulatedInstructionsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 EmulatedInstructionsForwardingCostBase = (ulong) (managementObject.Properties["EmulatedInstructionsForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 ExternalInterruptsCostBase = (ulong) (managementObject.Properties["ExternalInterruptsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 GlobalIotlbFlushCostBase = (ulong) (managementObject.Properties["GlobalIOTLBFlushCost_Base"]?.Value ?? default(ulong)),
		 ...
		 HltInstructionsCostBase = (ulong) (managementObject.Properties["HLTInstructionsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 HltInstructionsForwardingCostBase = (ulong) (managementObject.Properties["HLTInstructionsForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 HypercallsCostBase = (ulong) (managementObject.Properties["HypercallsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 HypercallsForwardingCostBase = (ulong) (managementObject.Properties["HypercallsForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 InvEptAllContextInstructionEmulationCostBase = (ulong) (managementObject.Properties["InvEptAllContextInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 InvEptSingleContextInstructionEmulationCostBase = (ulong) (managementObject.Properties["InvEptSingleContextInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 InvVpidAllContextInstructionEmulationCostBase = (ulong) (managementObject.Properties["InvVpidAllContextInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 InvVpidSingleAddressInstructionEmulationCostBase = (ulong) (managementObject.Properties["InvVpidSingleAddressInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 InvVpidSingleContextInstructionEmulationCostBase = (ulong) (managementObject.Properties["InvVpidSingleContextInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 IoInstructionsCost = (ulong) (managementObject.Properties["IOInstructionsCost"]?.Value ?? default(ulong)),
		 IoInstructionsCostBase = (ulong) (managementObject.Properties["IOInstructionsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 IoInstructionsForwardingCostBase = (ulong) (managementObject.Properties["IOInstructionsForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 LocalIotlbFlushCostBase = (ulong) (managementObject.Properties["LocalIOTLBFlushCost_Base"]?.Value ?? default(ulong)),
		 ...
		 MsrAccessesCostBase = (ulong) (managementObject.Properties["MSRAccessesCost_Base"]?.Value ?? default(ulong)),
		 ...
		 MsrAccessesForwardingCostBase = (ulong) (managementObject.Properties["MSRAccessesForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 MwaitInstructionsCostBase = (ulong) (managementObject.Properties["MWAITInstructionsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 MwaitInstructionsForwardingCostBase = (ulong) (managementObject.Properties["MWAITInstructionsForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 NestedPageFaultInterceptsCostBase = (ulong) (managementObject.Properties["NestedPageFaultInterceptsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 NestedSlatHardPageFaultsCostBase = (ulong) (managementObject.Properties["NestedSLATHardPageFaultsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 NestedSlatSoftPageFaultsCostBase = (ulong) (managementObject.Properties["NestedSLATSoftPageFaultsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 NestedVmEntriesCostBase = (ulong) (managementObject.Properties["NestedVMEntriesCost_Base"]?.Value ?? default(ulong)),
		 ...
		 OtherInterceptsCostBase = (ulong) (managementObject.Properties["OtherInterceptsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 OtherInterceptsForwardingCostBase = (ulong) (managementObject.Properties["OtherInterceptsForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 PageFaultInterceptsCostBase = (ulong) (managementObject.Properties["PageFaultInterceptsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 PageFaultInterceptsForwardingCostBase = (ulong) (managementObject.Properties["PageFaultInterceptsForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 PageInvalidationsCostBase = (ulong) (managementObject.Properties["PageInvalidationsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 PageInvalidationsForwardingCostBase = (ulong) (managementObject.Properties["PageInvalidationsForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 PendingInterruptsCostBase = (ulong) (managementObject.Properties["PendingInterruptsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 PendingInterruptsForwardingCostBase = (ulong) (managementObject.Properties["PendingInterruptsForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 PercentRemoteRunTimeBase = (ulong) (managementObject.Properties["PercentRemoteRunTime_Base"]?.Value ?? default(ulong)),
		 ...
		 TotalInterceptsCostBase = (ulong) (managementObject.Properties["TotalInterceptsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 TotalVirtualizationInstructionsEmulationCostBase = (ulong) (managementObject.Properties["TotalVirtualizationInstructionsEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 VmclearInstructionEmulationCostBase = (ulong) (managementObject.Properties["VMCLEARInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 VmptrldInstructionEmulationCostBase = (ulong) (managementObject.Properties["VMPTRLDInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 VmptrstInstructionEmulationCostBase = (ulong) (managementObject.Properties["VMPTRSTInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 VmreadInstructionEmulationCostBase = (ulong) (managementObject.Properties["VMREADInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 VmwriteInstructionEmulationCostBase = (ulong) (managementObject.Properties["VMWRITEInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 VmxoffInstructionEmulationCostBase = (ulong) (managementObject.Properties["VMXOFFInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 VmxonInstructionEmulationCostBase = (ulong) (managementObject.Properties["VMXONInstructionEmulationCost_Base"]?.Value ?? default(ulong))
                };
        }
    }
}