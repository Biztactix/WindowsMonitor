...
namespace WindowsMonitor.Win32.Performance.Raw.HyperVisor
{
    /// <summary>
    /// </summary>
    public sealed class CountersHyperVVirtualMachineBusPipes
    {
        ...
        public static IEnumerable<CountersHyperVVirtualMachineBusPipes> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<CountersHyperVVirtualMachineBusPipes> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<CountersHyperVVirtualMachineBusPipes> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new CountersHyperVVirtualMachineBusPipes
                {
