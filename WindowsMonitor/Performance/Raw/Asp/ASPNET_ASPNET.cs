...
namespace WindowsMonitor.Win32.Performance.Raw.Asp
{
    /// <summary>
    /// </summary>
    public sealed class AspnetAspnet
    {
        ...
        public static IEnumerable<AspnetAspnet> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<AspnetAspnet> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<AspnetAspnet> Retrieve(ManagementScope managementScope)
        {
