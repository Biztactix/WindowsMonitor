...
namespace WindowsMonitor.Win32.Performance.Raw
{
    /// <summary>
    /// </summary>
    public sealed class MsdtcBridge4000
    {
		public uint Averageparticipantcommitresponsetime { get; private set; }
		public uint AverageparticipantcommitresponsetimeBase { get; private set; }
		public uint Averageparticipantprepareresponsetime { get; private set; }
		public uint AverageparticipantprepareresponsetimeBase { get; private set; }
        ...
        public static IEnumerable<MsdtcBridge4000> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MsdtcBridge4000> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MsdtcBridge4000> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MsdtcBridge4000
                {
		 ...
		 AverageparticipantcommitresponsetimeBase = (uint) (managementObject.Properties["Averageparticipantcommitresponsetime_Base"]?.Value ?? default(uint)),
		 ...
		 AverageparticipantprepareresponsetimeBase = (uint) (managementObject.Properties["Averageparticipantprepareresponsetime_Base"]?.Value ?? default(uint)),
