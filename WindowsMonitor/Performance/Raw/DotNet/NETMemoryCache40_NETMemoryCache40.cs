...
namespace WindowsMonitor.Win32.Performance.Raw.DotNet
{
    /// <summary>
    /// </summary>
    public sealed class NetMemoryCache40NetMemoryCache40
    {
		public uint CacheEntries { get; private set; }
		public uint CacheHitRatio { get; private set; }
		public uint CacheHitRatioBase { get; private set; }
        ...
        public static IEnumerable<NetMemoryCache40NetMemoryCache40> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<NetMemoryCache40NetMemoryCache40> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<NetMemoryCache40NetMemoryCache40> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new NetMemoryCache40NetMemoryCache40
                {
		 ...
		 CacheHitRatioBase = (uint) (managementObject.Properties["CacheHitRatio_Base"]?.Value ?? default(uint)),
