...
namespace WindowsMonitor.Win32.Performance.Raw.DotNet
{
    /// <summary>
    /// </summary>
    public sealed class NetclrDataNetclrData
    {
        ...
        public static IEnumerable<NetclrDataNetclrData> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<NetclrDataNetclrData> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<NetclrDataNetclrData> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new NetclrDataNetclrData
                {
