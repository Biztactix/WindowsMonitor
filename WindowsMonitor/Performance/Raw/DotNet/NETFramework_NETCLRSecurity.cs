...
namespace WindowsMonitor.Win32.Performance.Raw.DotNet
{
    /// <summary>
    /// </summary>
    public sealed class NetFrameworkNetclrSecurity
    {
		...
		public uint PercentTimeinRTchecksBase { get; private set; }
        ...
        public static IEnumerable<NetFrameworkNetclrSecurity> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<NetFrameworkNetclrSecurity> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<NetFrameworkNetclrSecurity> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new NetFrameworkNetclrSecurity
                {
		 ...
		 PercentTimeinRTchecksBase = (uint) (managementObject.Properties["PercentTimeinRTchecks_Base"]?.Value ?? default(uint)),
