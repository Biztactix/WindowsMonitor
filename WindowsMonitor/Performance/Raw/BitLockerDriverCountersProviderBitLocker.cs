...
namespace WindowsMonitor.Win32.Performance.Raw
{
    /// <summary>
    /// </summary>
    public sealed class BitLockerDriverCountersProviderBitLocker
    {
        ...
        public static IEnumerable<BitLockerDriverCountersProviderBitLocker> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<BitLockerDriverCountersProviderBitLocker> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<BitLockerDriverCountersProviderBitLocker> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new BitLockerDriverCountersProviderBitLocker
                {
