...
namespace WindowsMonitor.Win32.Performance.Raw.Network
{
    ...
    public sealed class IcmpV6
    {
        ...
        public static IEnumerable<IcmpV6> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<IcmpV6> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<IcmpV6> Retrieve(ManagementScope managementScope)
        {
