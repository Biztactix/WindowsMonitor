...
namespace WindowsMonitor.Win32.Performance.Raw.Network.Nat
{
    /// <summary>
    /// </summary>
    public sealed class WinNatCountersWinNatudp
    {
        ...
        public static IEnumerable<WinNatCountersWinNatudp> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<WinNatCountersWinNatudp> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<WinNatCountersWinNatudp> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new WinNatCountersWinNatudp
                {
