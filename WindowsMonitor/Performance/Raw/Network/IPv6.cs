...
namespace WindowsMonitor.Win32.Performance.Raw.Network
{
    ...
    public sealed class IpV6
    {
        ...
        public static IEnumerable<IpV6> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<IpV6> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<IpV6> Retrieve(ManagementScope managementScope)
        {
