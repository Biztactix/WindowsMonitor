        ...
        public static IEnumerable<FaxService> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new FaxService
                {
                    ...
                    Failedfaxestransmissions =
                        (uint) (managementObject.Properties["Failedfaxestransmissions"]?.Value ?? default(uint)),
                    Failedoutgoingconnections =
                        (uint) (managementObject.Properties["Failedoutgoingconnections"]?.Value ?? default(uint)),
                    ...
                    Totalfaxessentandreceived =
                        (uint) (managementObject.Properties["Totalfaxessentandreceived"]?.Value ?? default(uint)),
                    Totalminutessendingandreceiving =
                        (uint) (managementObject.Properties["Totalminutessendingandreceiving"]?.Value ?? default(uint)),
