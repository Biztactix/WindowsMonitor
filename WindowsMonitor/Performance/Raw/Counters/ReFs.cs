...
namespace WindowsMonitor.Win32.Performance.Raw.Counters
{
    ...
    public sealed class ReFs
    {
        ...
        public uint Checkpointlatency100NsBase { get; private set; }
        public ulong CheckpointsPersec { get; private set; }
        public ulong Compactionreadlatency100Ns { get; private set; }
        public uint Compactionreadlatency100NsBase { get; private set; }
        public ulong Compactionwritelatency100Ns { get; private set; }
        public uint Compactionwritelatency100NsBase { get; private set; }
        ...
        public uint FastTierDestagedContainerFillRatioPercentBase { get; private set; }
        public ulong Fasttierdestagereadlatency100Ns { get; private set; }
        public uint Fasttierdestagereadlatency100NsBase { get; private set; }
        public ulong Fasttierdestagewritelatency100Ns { get; private set; }
        public uint Fasttierdestagewritelatency100NsBase { get; private set; }
        ...
        public uint SlowTierDestagedContainerFillRatioPercentBase { get; private set; }
        public ulong Slowtierdestagereadlatency100Ns { get; private set; }
        public uint Slowtierdestagereadlatency100NsBase { get; private set; }
        public ulong Slowtierdestagewritelatency100Ns { get; private set; }
        public uint Slowtierdestagewritelatency100NsBase { get; private set; }
        ...
        public uint Treeupdatelatency100NsBase { get; private set; }
        public ulong TreeupdatesPersec { get; private set; }
        public ulong Trimlatency100Ns { get; private set; }
        public uint Trimlatency100NsBase { get; private set; }
        ...
        public static IEnumerable<ReFs> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new ReFs
                {
                    ...
                    BytesReadfromCachePersec =
                        (ulong) (managementObject.Properties["BytesReadfromCachePersec"]?.Value ?? default(ulong)),
                    BytesReadMissingCachePersec =
                        (ulong) (managementObject.Properties["BytesReadMissingCachePersec"]?.Value ?? default(ulong)),
                    CacheAllocated = (ulong) (managementObject.Properties["CacheAllocated"]?.Value ?? default(ulong)),
                    CacheAllocationsPersec =
                        (ulong) (managementObject.Properties["CacheAllocationsPersec"]?.Value ?? default(ulong)),
                    CacheAllocationUnitSize =
                        (uint) (managementObject.Properties["CacheAllocationUnitSize"]?.Value ?? default(uint)),
                    ...
                    CacheInvalidationsinBytesPersec =
                        (ulong) (managementObject.Properties["CacheInvalidationsinBytesPersec"]?.Value ??
                                 default(ulong)),
                    CacheInvalidationsPersec =
                        (ulong) (managementObject.Properties["CacheInvalidationsPersec"]?.Value ?? default(ulong)),
                    CacheLinesFree = (uint) (managementObject.Properties["CacheLinesFree"]?.Value ?? default(uint)),
                    CacheLinesInError =
                        (uint) (managementObject.Properties["CacheLinesInError"]?.Value ?? default(uint)),
                    CacheMetadataWrittenBytesPersec =
                        (ulong) (managementObject.Properties["CacheMetadataWrittenBytesPersec"]?.Value ??
                                 default(ulong)),
                    CacheMissesPersec =
                        (ulong) (managementObject.Properties["CacheMissesPersec"]?.Value ?? default(ulong)),
                    CachePopulationsBytesPersec =
                        (ulong) (managementObject.Properties["CachePopulationsBytesPersec"]?.Value ?? default(ulong)),
                    CachePopulationsPersec =
                        (ulong) (managementObject.Properties["CachePopulationsPersec"]?.Value ?? default(ulong)),
                    ...
                    Checkpointlatency100Ns =
                        (ulong) (managementObject.Properties["Checkpointlatency100ns"]?.Value ?? default(ulong)),
                    Checkpointlatency100NsBase =
                        (uint) (managementObject.Properties["Checkpointlatency100ns_Base"]?.Value ?? default(uint)),
                    CheckpointsPersec =
                        (ulong) (managementObject.Properties["CheckpointsPersec"]?.Value ?? default(ulong)),
                    Compactionreadlatency100Ns =
                        (ulong) (managementObject.Properties["Compactionreadlatency100ns"]?.Value ?? default(ulong)),
                    Compactionreadlatency100NsBase =
                        (uint) (managementObject.Properties["Compactionreadlatency100ns_Base"]?.Value ?? default(uint)),
                    Compactionwritelatency100Ns =
                        (ulong) (managementObject.Properties["Compactionwritelatency100ns"]?.Value ?? default(ulong)),
                    Compactionwritelatency100NsBase =
                    ...
                    DataAllocationsFastTierPersec =
                        (ulong) (managementObject.Properties["DataAllocationsFastTierPersec"]?.Value ?? default(ulong)),
                    DataAllocationsSlowTierPersec =
                        (ulong) (managementObject.Properties["DataAllocationsSlowTierPersec"]?.Value ?? default(ulong)),
                    DataCompactionsPersec =
                        (ulong) (managementObject.Properties["DataCompactionsPersec"]?.Value ?? default(ulong)),
                    DataInPlaceWritesPersec =
                        (ulong) (managementObject.Properties["DataInPlaceWritesPersec"]?.Value ?? default(ulong)),
                    Description = (string) managementObject.Properties["Description"]?.Value,
                    Fasttierdatadestagecriteriapercentage =
                        (uint) (managementObject.Properties["Fasttierdatadestagecriteriapercentage"]?.Value ??
                                default(uint)),
                    FastTierDestagedContainerFillRatioPercent =
                        (ulong) (managementObject.Properties["FastTierDestagedContainerFillRatioPercent"]?.Value ??
                                 default(ulong)),
                    FastTierDestagedContainerFillRatioPercentBase =
                        (uint) (managementObject.Properties["FastTierDestagedContainerFillRatioPercent_Base"]?.Value ??
                                default(uint)),
                    Fasttierdestagereadlatency100Ns =
                        (ulong) (managementObject.Properties["Fasttierdestagereadlatency100ns"]?.Value ??
                                 default(ulong)),
                    Fasttierdestagereadlatency100NsBase =
                        (uint) (managementObject.Properties["Fasttierdestagereadlatency100ns_Base"]?.Value ??
                                default(uint)),
                    Fasttierdestagewritelatency100Ns =
                        (ulong) (managementObject.Properties["Fasttierdestagewritelatency100ns"]?.Value ??
                                 default(ulong)),
                    Fasttierdestagewritelatency100NsBase =
                        (uint) (managementObject.Properties["Fasttierdestagewritelatency100ns_Base"]?.Value ??
                                default(uint)),
                    Fasttiermetadatadestagecriteriapercentage =
                        (uint) (managementObject.Properties["Fasttiermetadatadestagecriteriapercentage"]?.Value ??
                                default(uint)),
                    FrequencyObject =
                    ...
                    Logfillpercentage =
                        (uint) (managementObject.Properties["Logfillpercentage"]?.Value ?? default(uint)),
                    LogwritesPersec = (ulong) (managementObject.Properties["LogwritesPersec"]?.Value ?? default(ulong)),
                    MaxTransactionsOutstanding =
                        (uint) (managementObject.Properties["MaxTransactionsOutstanding"]?.Value ?? default(uint)),
                    ...
                    Slowtierdatadestagecriteriapercentage =
                        (uint) (managementObject.Properties["Slowtierdatadestagecriteriapercentage"]?.Value ??
                                default(uint)),
                    SlowTierDestagedContainerFillRatioPercent =
                        (ulong) (managementObject.Properties["SlowTierDestagedContainerFillRatioPercent"]?.Value ??
                                 default(ulong)),
                    SlowTierDestagedContainerFillRatioPercentBase =
                        (uint) (managementObject.Properties["SlowTierDestagedContainerFillRatioPercent_Base"]?.Value ??
                                default(uint)),
                    Slowtierdestagereadlatency100Ns =
                        (ulong) (managementObject.Properties["Slowtierdestagereadlatency100ns"]?.Value ??
                                 default(ulong)),
                    Slowtierdestagereadlatency100NsBase =
                        (uint) (managementObject.Properties["Slowtierdestagereadlatency100ns_Base"]?.Value ??
                                default(uint)),
                    Slowtierdestagewritelatency100Ns =
                        (ulong) (managementObject.Properties["Slowtierdestagewritelatency100ns"]?.Value ??
                                 default(ulong)),
                    Slowtierdestagewritelatency100NsBase =
                        (uint) (managementObject.Properties["Slowtierdestagewritelatency100ns_Base"]?.Value ??
                                default(uint)),
                    Slowtiermetadatadestagecriteriapercentage =
                        (uint) (managementObject.Properties["Slowtiermetadatadestagecriteriapercentage"]?.Value ??
                                default(uint)),
                    ...
                    TotalAllocationsPersec =
                        (ulong) (managementObject.Properties["TotalAllocationsPersec"]?.Value ?? default(ulong)),
                    TransactionsOutstanding =
                        (uint) (managementObject.Properties["TransactionsOutstanding"]?.Value ?? default(uint)),
                    Treeupdatelatency100Ns =
                        (ulong) (managementObject.Properties["Treeupdatelatency100ns"]?.Value ?? default(ulong)),
                    Treeupdatelatency100NsBase =
                        (uint) (managementObject.Properties["Treeupdatelatency100ns_Base"]?.Value ?? default(uint)),
                    TreeupdatesPersec =
                        (ulong) (managementObject.Properties["TreeupdatesPersec"]?.Value ?? default(ulong)),
                    Trimlatency100Ns =
                        (ulong) (managementObject.Properties["Trimlatency100ns"]?.Value ?? default(ulong)),
                    Trimlatency100NsBase =
                        (uint) (managementObject.Properties["Trimlatency100ns_Base"]?.Value ?? default(uint))
                };
        }
    }
}