...
namespace WindowsMonitor.Win32.Performance.Raw.Counters
{
    ...
    public sealed class PacketDirectEcUtilization
    {
		...
		public ulong PercentBusyWaitingTimeBase { get; private set; }
		public uint PercentBusyWaitIterations { get; private set; }
		public uint PercentBusyWaitIterationsBase { get; private set; }
		...
		public ulong PercentProcessingTimeBase { get; private set; }
        ...
        public static IEnumerable<PacketDirectEcUtilization> Retrieve(ManagementScope managementScope)
        {
		 ...
		 PercentBusyWaitingTimeBase = (ulong) (managementObject.Properties["PercentBusyWaitingTime_Base"]?.Value ?? default(ulong)),
		 PercentBusyWaitIterations = (uint) (managementObject.Properties["PercentBusyWaitIterations"]?.Value ?? default(uint)),
		 PercentBusyWaitIterationsBase = (uint) (managementObject.Properties["PercentBusyWaitIterations_Base"]?.Value ?? default(uint)),
		 ...
		 PercentProcessingTimeBase = (ulong) (managementObject.Properties["PercentProcessingTime_Base"]?.Value ?? default(ulong)),
