...
namespace WindowsMonitor.Win32.Performance.Raw.Counters
{
    /// <summary>
    /// </summary>
    public sealed class Dns64Global
    {
        ...
        public static IEnumerable<Dns64Global> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<Dns64Global> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<Dns64Global> Retrieve(ManagementScope managementScope)
        {
