...
namespace WindowsMonitor.Win32.Performance.Raw.Counters
{
    ...
    public sealed class WfPv6
    {
        ...
        public static IEnumerable<WfPv6> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<WfPv6> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<WfPv6> Retrieve(ManagementScope managementScope)
        {
