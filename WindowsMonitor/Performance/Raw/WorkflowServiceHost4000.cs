...
namespace WindowsMonitor.Win32.Performance.Raw
{
    ...
    public sealed class WorkflowServiceHost4000
    {
		...
		public uint AverageWorkflowLoadTimeBase { get; private set; }
		public uint AverageWorkflowPersistTime { get; private set; }
		public uint AverageWorkflowPersistTimeBase { get; private set; }
        ...
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_WorkflowServiceHost4000_WorkflowServiceHost4000");
		 ...
		 AverageWorkflowLoadTimeBase = (uint) (managementObject.Properties["AverageWorkflowLoadTime_Base"]?.Value ?? default(uint)),
		 AverageWorkflowPersistTime = (uint) (managementObject.Properties["AverageWorkflowPersistTime"]?.Value ?? default(uint)),
		 AverageWorkflowPersistTimeBase = (uint) (managementObject.Properties["AverageWorkflowPersistTime_Base"]?.Value ?? default(uint)),
