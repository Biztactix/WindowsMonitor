...
namespace WindowsMonitor.Performance.Formatted
{
    /// <summary>
    /// </summary>
    public sealed class FaxServiceFaxService
    {
        ...
        public static IEnumerable<FaxServiceFaxService> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<FaxServiceFaxService> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<FaxServiceFaxService> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new FaxServiceFaxService
                {
