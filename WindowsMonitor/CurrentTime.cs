...
namespace WindowsMonitor.Win32
{
    ...
    public sealed class CurrentTime
    {
        ...
        public static IEnumerable<CurrentTime> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<CurrentTime> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<CurrentTime> Retrieve(ManagementScope managementScope)
        {
