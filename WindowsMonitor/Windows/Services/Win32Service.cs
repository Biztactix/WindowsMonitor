...
namespace WindowsMonitor.Window.Services
{
    ...
    public sealed class Win32Service
    {
        ...
        public static IEnumerable<Win32Service> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<Win32Service> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<Win32Service> Retrieve(ManagementScope managementScope)
        {
