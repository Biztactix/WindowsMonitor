...
namespace WindowsMonitor.MSFT.WmiProviders
{
    ...
    public sealed class Counters
    {
        ...
        public static IEnumerable<Counters> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<Counters> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<Counters> Retrieve(ManagementScope managementScope)
        {
