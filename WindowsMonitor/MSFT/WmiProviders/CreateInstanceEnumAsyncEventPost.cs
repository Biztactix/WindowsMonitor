...
namespace WindowsMonitor.MSFT.WmiProviders
{
    /// <summary>
    /// </summary>
    public sealed class CreateInstanceEnumAsyncEventPost
    {
        ...
        public static IEnumerable<CreateInstanceEnumAsyncEventPost> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<CreateInstanceEnumAsyncEventPost> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<CreateInstanceEnumAsyncEventPost> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new CreateInstanceEnumAsyncEventPost
                {
                     ClassName = (string) (managementObject.Properties["ClassName"]?.Value),
