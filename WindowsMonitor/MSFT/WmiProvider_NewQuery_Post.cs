...
namespace WindowsMonitor.Msft
{
    /// <summary>
    /// </summary>
    public sealed class WmiProvider_NewQuery_Post
    {
        ...
        public static IEnumerable<WmiProvider_NewQuery_Post> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<WmiProvider_NewQuery_Post> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<WmiProvider_NewQuery_Post> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new WmiProvider_NewQuery_Post
                {
