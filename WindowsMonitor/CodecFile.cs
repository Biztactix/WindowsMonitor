...
namespace WindowsMonitor
{
    ...
    public sealed class CodecFile
    {
        ...
        public static IEnumerable<CodecFile> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<CodecFile> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<CodecFile> Retrieve(ManagementScope managementScope)
        {
