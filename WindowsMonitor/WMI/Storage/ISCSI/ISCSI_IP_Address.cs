...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class ISCSI_IP_Address
    {
        ...
        public static IEnumerable<ISCSI_IP_Address> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<ISCSI_IP_Address> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<ISCSI_IP_Address> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new ISCSI_IP_Address
                {
