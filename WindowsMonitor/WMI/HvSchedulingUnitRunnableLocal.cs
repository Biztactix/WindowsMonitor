...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class HvSchedulingUnitRunnableLocal
    {
        ...
        public static IEnumerable<HvSchedulingUnitRunnableLocal> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<HvSchedulingUnitRunnableLocal> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<HvSchedulingUnitRunnableLocal> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM HvSchedulingUnitRunnableLocal");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            foreach (ManagementObject managementObject in objectCollection)
                yield return new HvSchedulingUnitRunnableLocal
                {
