...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class ProcessorAcpiTsdDependency
    {
        ...
        public static IEnumerable<ProcessorAcpiTsdDependency> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<ProcessorAcpiTsdDependency> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<ProcessorAcpiTsdDependency> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM ProcessorAcpiTsdDependency");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            foreach (ManagementObject managementObject in objectCollection)
                yield return new ProcessorAcpiTsdDependency
                {
