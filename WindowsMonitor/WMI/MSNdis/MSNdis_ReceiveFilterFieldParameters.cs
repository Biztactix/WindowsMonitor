...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSNdis_ReceiveFilterFieldParameters
    {
        ...
        public static IEnumerable<MSNdis_ReceiveFilterFieldParameters> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSNdis_ReceiveFilterFieldParameters> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSNdis_ReceiveFilterFieldParameters> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSNdis_ReceiveFilterFieldParameters
                {
