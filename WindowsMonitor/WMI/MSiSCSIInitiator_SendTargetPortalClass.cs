...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSiSCSIInitiator_SendTargetPortalClass
    {
        ...
        public static IEnumerable<MSiSCSIInitiator_SendTargetPortalClass> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSiSCSIInitiator_SendTargetPortalClass> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSiSCSIInitiator_SendTargetPortalClass> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSiSCSIInitiator_SendTargetPortalClass
                {
