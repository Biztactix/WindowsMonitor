...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class HvMsrRead
    {
		public ulong GuestRip { get; private set; }
		public ulong Index { get; private set; }
		public ulong Value { get; private set; }

        public static IEnumerable<HvMsrRead> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<HvMsrRead> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM HvMsrRead");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            foreach (ManagementObject managementObject in objectCollection)
                yield return new HvMsrRead
                {
