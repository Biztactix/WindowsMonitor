...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSSmBios_SMBiosEventlog
    {
        ...
        public static IEnumerable<MSSmBios_SMBiosEventlog> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSSmBios_SMBiosEventlog> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSSmBios_SMBiosEventlog> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSSmBios_SMBiosEventlog
                {
