...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSSerial_CommProperties
    {
        ...
        public static IEnumerable<MSSerial_CommProperties> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSSerial_CommProperties> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSSerial_CommProperties> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSSerial_CommProperties
                {
		 ...
		 dwProvCapabilities = (uint) (managementObject.Properties["dwProvCapabilities"]?.Value ?? default(uint)),
		 ...
		 wSettableStopParity = (ushort) (managementObject.Properties["wSettableStopParity"]?.Value ?? default(ushort))
                };
        }
    }
}