...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSDiskDriver_Geometry
    {
        ...
        public static IEnumerable<MSDiskDriver_Geometry> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSDiskDriver_Geometry> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSDiskDriver_Geometry> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSDiskDriver_Geometry
                {
