...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class IdleAccountingEx
    {
        ...
        public static IEnumerable<IdleAccountingEx> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<IdleAccountingEx> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<IdleAccountingEx> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM IdleAccountingEx");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            foreach (ManagementObject managementObject in objectCollection)
                yield return new IdleAccountingEx
                {
