...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class UmsDirectedSwitchStart
    {
        ...
        public static IEnumerable<UmsDirectedSwitchStart> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<UmsDirectedSwitchStart> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<UmsDirectedSwitchStart> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM UmsDirectedSwitchStart");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            foreach (ManagementObject managementObject in objectCollection)
                yield return new UmsDirectedSwitchStart
                {
