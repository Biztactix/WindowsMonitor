...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MS_SMHBA_PROTOCOLSTATISTICS
    {
        ...
        public static IEnumerable<MS_SMHBA_PROTOCOLSTATISTICS> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MS_SMHBA_PROTOCOLSTATISTICS> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MS_SMHBA_PROTOCOLSTATISTICS> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MS_SMHBA_PROTOCOLSTATISTICS
                {
