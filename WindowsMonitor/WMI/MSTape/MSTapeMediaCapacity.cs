...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSTapeMediaCapacity
    {
        ...
        public static IEnumerable<MSTapeMediaCapacity> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSTapeMediaCapacity> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSTapeMediaCapacity> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSTapeMediaCapacity
                {
