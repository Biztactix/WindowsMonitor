...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSNdis_PortChar
    {
        ...
        public static IEnumerable<MSNdis_PortChar> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSNdis_PortChar> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSNdis_PortChar> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSNdis_PortChar
                {
