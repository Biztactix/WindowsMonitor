...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSNdis_StatusDot11ConnectionStart
    {
        ...
        public static IEnumerable<MSNdis_StatusDot11ConnectionStart> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSNdis_StatusDot11ConnectionStart> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSNdis_StatusDot11ConnectionStart> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSNdis_StatusDot11ConnectionStart
                {
