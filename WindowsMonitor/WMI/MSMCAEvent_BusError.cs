...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSMCAEvent_BusError
    {
		...
		public uint MemOrIo { get; private set; }
		public uint MemoryHierarchyLevel { get; private set; }
		public uint Participation { get; private set; }
        ...
        public static IEnumerable<MSMCAEvent_BusError> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSMCAEvent_BusError> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSMCAEvent_BusError> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM MSMCAEvent_BusError");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSMCAEvent_BusError
                {
		 ...
		 MemOrIo = (uint) (managementObject.Properties["MemOrIo"]?.Value ?? default(uint)),
		 MemoryHierarchyLevel = (uint) (managementObject.Properties["MemoryHierarchyLevel"]?.Value ?? default(uint)),
		 Participation = (uint) (managementObject.Properties["Participation"]?.Value ?? default(uint)),
