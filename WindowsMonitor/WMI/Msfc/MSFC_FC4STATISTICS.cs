...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSFC_FC4STATISTICS
    {
        ...
        public static IEnumerable<MSFC_FC4STATISTICS> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSFC_FC4STATISTICS> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSFC_FC4STATISTICS> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSFC_FC4STATISTICS
                {
