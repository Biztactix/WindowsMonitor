...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSTapeProblemIoError
    {
        ...
        public static IEnumerable<MSTapeProblemIoError> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSTapeProblemIoError> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSTapeProblemIoError> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSTapeProblemIoError
                {
