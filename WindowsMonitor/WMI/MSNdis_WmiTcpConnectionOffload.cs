...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSNdis_WmiTcpConnectionOffload
    {
        ...
        public static IEnumerable<MSNdis_WmiTcpConnectionOffload> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSNdis_WmiTcpConnectionOffload> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSNdis_WmiTcpConnectionOffload> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSNdis_WmiTcpConnectionOffload
                {
