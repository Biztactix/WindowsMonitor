...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSiSCSI_NICConfig
    {
        ...
        public static IEnumerable<MSiSCSI_NICConfig> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSiSCSI_NICConfig> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSiSCSI_NICConfig> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSiSCSI_NICConfig
                {
