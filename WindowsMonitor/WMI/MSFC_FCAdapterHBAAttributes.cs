...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSFC_FCAdapterHBAAttributes
    {
        ...
        public static IEnumerable<MSFC_FCAdapterHBAAttributes> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSFC_FCAdapterHBAAttributes> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSFC_FCAdapterHBAAttributes> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSFC_FCAdapterHBAAttributes
                {
