...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class UdpIp_TypeGroup2
    {
        ...
        public static IEnumerable<UdpIp_TypeGroup2> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<UdpIp_TypeGroup2> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<UdpIp_TypeGroup2> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new UdpIp_TypeGroup2
                {
