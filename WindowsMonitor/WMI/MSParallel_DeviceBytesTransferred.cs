...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSParallel_DeviceBytesTransferred
    {
        ...
        public static IEnumerable<MSParallel_DeviceBytesTransferred> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSParallel_DeviceBytesTransferred> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSParallel_DeviceBytesTransferred> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSParallel_DeviceBytesTransferred
                {
