...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class TcpIp_TypeGroup4
    {
        ...
        public static IEnumerable<TcpIp_TypeGroup4> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<TcpIp_TypeGroup4> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<TcpIp_TypeGroup4> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new TcpIp_TypeGroup4
                {
