...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSSerial_CommInfo
    {
        ...
        public static IEnumerable<MSSerial_CommInfo> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSSerial_CommInfo> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSSerial_CommInfo> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSSerial_CommInfo
                {
		 ...
		 ParityCheckEnable = (bool) (managementObject.Properties["ParityCheckEnable"]?.Value ?? default(bool)),
		 ...
		 SupportIntervalTimeouts = (bool) (managementObject.Properties["SupportIntervalTimeouts"]?.Value ?? default(bool)),
		 SupportParityCheck = (bool) (managementObject.Properties["SupportParityCheck"]?.Value ?? default(bool)),
