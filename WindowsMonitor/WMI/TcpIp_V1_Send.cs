...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class TcpIp_V1_Send
    {
        ...
        public static IEnumerable<TcpIp_V1_Send> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<TcpIp_V1_Send> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<TcpIp_V1_Send> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new TcpIp_V1_Send
                {
