...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class DedupTracingEventClass_DedupTracingEventTypeClass
    {
        ...
        public static IEnumerable<DedupTracingEventClass_DedupTracingEventTypeClass> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<DedupTracingEventClass_DedupTracingEventTypeClass> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<DedupTracingEventClass_DedupTracingEventTypeClass> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM DedupTracingEventClass_DedupTracingEventTypeClass");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            foreach (ManagementObject managementObject in objectCollection)
                yield return new DedupTracingEventClass_DedupTracingEventTypeClass
                {
