...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSiSCSIInitiator_PersistentLoginClass
    {
        ...
        public static IEnumerable<MSiSCSIInitiator_PersistentLoginClass> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSiSCSIInitiator_PersistentLoginClass> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSiSCSIInitiator_PersistentLoginClass> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSiSCSIInitiator_PersistentLoginClass
                {
