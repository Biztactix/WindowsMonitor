...
namespace WindowsMonitor.WMI.AspNet
{
    /// <summary>
    /// </summary>
    public sealed class AspNetWebEventRaiseStart
    {
		...
		public string EventDetailCode { get; private set; }
		public uint Flags { get; private set; }
		public uint Level { get; private set; }

        public static IEnumerable<AspNetWebEventRaiseStart> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<AspNetWebEventRaiseStart> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<AspNetWebEventRaiseStart> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM AspNetWebEventRaiseStart");
		 ...
		 EventDetailCode = (string) (managementObject.Properties["EventDetailCode"]?.Value ?? default(string)),
