...
namespace WindowsMonitor.WMI
{
    ...
    public sealed class FltIoInit
    {
        ...
        public static IEnumerable<FltIoInit> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<FltIoInit> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<FltIoInit> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM FltIoInit");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            foreach (ManagementObject managementObject in objectCollection)
                yield return new FltIoInit
                {
