...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSNdis_WmiTcpIpChecksumOffload_IPv6TransmitReceive
    {
        ...
        public static IEnumerable<MSNdis_WmiTcpIpChecksumOffload_IPv6TransmitReceive> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSNdis_WmiTcpIpChecksumOffload_IPv6TransmitReceive> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSNdis_WmiTcpIpChecksumOffload_IPv6TransmitReceive> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSNdis_WmiTcpIpChecksumOffload_IPv6TransmitReceive
                {
