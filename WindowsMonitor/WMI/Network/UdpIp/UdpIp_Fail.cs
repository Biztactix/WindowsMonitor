...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class UdpIp_Fail
    {
		public ushort FailureCode { get; private set; }
		public uint Flags { get; private set; }
		public ushort Proto { get; private set; }

        public static IEnumerable<UdpIp_Fail> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<UdpIp_Fail> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<UdpIp_Fail> Retrieve(ManagementScope managementScope)
        {
