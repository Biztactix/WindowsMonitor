...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSNdis_StatusDot11Disassociation
    {
        ...
        public static IEnumerable<MSNdis_StatusDot11Disassociation> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSNdis_StatusDot11Disassociation> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSNdis_StatusDot11Disassociation> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSNdis_StatusDot11Disassociation
                {
