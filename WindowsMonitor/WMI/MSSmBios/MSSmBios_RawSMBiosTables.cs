...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSSmBios_RawSMBiosTables
    {
        ...
        public static IEnumerable<MSSmBios_RawSMBiosTables> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSSmBios_RawSMBiosTables> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSSmBios_RawSMBiosTables> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSSmBios_RawSMBiosTables
                {
