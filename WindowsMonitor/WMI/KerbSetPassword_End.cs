...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class KerbSetPassword_End
    {
        ...
        public static IEnumerable<KerbSetPassword_End> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<KerbSetPassword_End> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<KerbSetPassword_End> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new KerbSetPassword_End
                {
