...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSNdis_GroupAffinity
    {
		public ushort Group { get; private set; }
		public ulong Mask { get; private set; }
		public ushort[] Reserved { get; private set; }

        public static IEnumerable<MSNdis_GroupAffinity> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSNdis_GroupAffinity> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSNdis_GroupAffinity> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSNdis_GroupAffinity
                {
