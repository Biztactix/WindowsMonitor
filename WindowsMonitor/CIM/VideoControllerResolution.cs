...
namespace WindowsMonitor.CIM
{
    /// <summary>
    /// </summary>
    public sealed class VideoControllerResolution
    {
		...
		public ulong NumberOfColors { get; private set; }
        ...
        public static IEnumerable<VideoControllerResolution> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<VideoControllerResolution> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<VideoControllerResolution> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM CIM_VideoControllerResolution");
