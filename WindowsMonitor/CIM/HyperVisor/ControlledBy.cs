...
namespace WindowsMonitor.CIM
{
    ...
    public sealed class ControlledBy
    {
        ...
        public static IEnumerable<ControlledBy> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<ControlledBy> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<ControlledBy> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM CIM_ControlledBy");
