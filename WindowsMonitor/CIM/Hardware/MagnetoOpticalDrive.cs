...
namespace WindowsMonitor.CIM.Hardware
{
    /// <summary>
    /// </summary>
    public sealed class MagnetoOpticalDrive
    {
        ...
        public static IEnumerable<MagnetoOpticalDrive> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MagnetoOpticalDrive> Retrieve()
        {
