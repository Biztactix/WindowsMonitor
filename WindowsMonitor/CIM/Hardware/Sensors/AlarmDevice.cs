...
namespace WindowsMonitor.CIM.Hardware.Sensors
{
    /// <summary>
    /// </summary>
    public sealed class AlarmDevice
    {
		...
		public ushort Urgency { get; private set; }
		public bool VisibleAlarm { get; private set; }

        public static IEnumerable<AlarmDevice> Retrieve(string remote, string username, string password)
        {
