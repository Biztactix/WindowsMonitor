...
namespace WindowsMonitor.CIM
{
    ...
    public sealed class Chip
    {
        ...
        public static IEnumerable<Chip> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<Chip> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<Chip> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM CIM_Chip");
