...
namespace WindowsMonitor.CIM
{
    /// <summary>
    /// </summary>
    public sealed class PhysicalFrame
    {
        ...
        public static IEnumerable<PhysicalFrame> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<PhysicalFrame> Retrieve()
        {
