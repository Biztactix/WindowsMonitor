...
namespace WindowsMonitor.Storage.ISCSI
{
    /// <summary>
    /// </summary>
    public sealed class MSiSCSI_HBASessionConfig
    {
        ...
        public static IEnumerable<MSiSCSI_HBASessionConfig> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSiSCSI_HBASessionConfig> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSiSCSI_HBASessionConfig> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSiSCSI_HBASessionConfig
                {
