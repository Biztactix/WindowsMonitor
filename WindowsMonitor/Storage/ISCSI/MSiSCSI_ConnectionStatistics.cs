...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSiSCSI_ConnectionStatistics
    {
        ...
        public static IEnumerable<MSiSCSI_ConnectionStatistics> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSiSCSI_ConnectionStatistics> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSiSCSI_ConnectionStatistics> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSiSCSI_ConnectionStatistics
                {
