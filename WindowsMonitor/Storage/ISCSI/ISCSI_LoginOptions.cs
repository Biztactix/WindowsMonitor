...
namespace WindowsMonitor.Storage.ISCSI
{
    /// <summary>
    /// </summary>
    public sealed class ISCSI_LoginOptions
    {
        ...
        public static IEnumerable<ISCSI_LoginOptions> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<ISCSI_LoginOptions> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<ISCSI_LoginOptions> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new ISCSI_LoginOptions
                {
