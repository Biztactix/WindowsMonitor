...
namespace WindowsMonitor.Storage.ISCSI
{
    /// <summary>
    /// </summary>
    public sealed class ISCSI_ConnectionStaticInfo
    {
        ...
        public static IEnumerable<ISCSI_ConnectionStaticInfo> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<ISCSI_ConnectionStaticInfo> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<ISCSI_ConnectionStaticInfo> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new ISCSI_ConnectionStaticInfo
                {
