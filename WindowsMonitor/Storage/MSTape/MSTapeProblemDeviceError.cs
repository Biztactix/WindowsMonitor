...
namespace WindowsMonitor.Storage.MSTape
{
    /// <summary>
    /// </summary>
    public sealed class MSTapeProblemDeviceError
    {
        ...
        public static IEnumerable<MSTapeProblemDeviceError> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSTapeProblemDeviceError> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSTapeProblemDeviceError> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSTapeProblemDeviceError
                {
