...
namespace WindowsMonitor.Storage.MSTape
{
    /// <summary>
    /// </summary>
    public sealed class MSTapeDriveParam
    {
        ...
        public static IEnumerable<MSTapeDriveParam> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSTapeDriveParam> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSTapeDriveParam> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSTapeDriveParam
                {
