...
namespace WindowsMonitor.Storage.ShadowCopy
{
    ...
    public sealed class ShadowFor
    {
        ...
        public static IEnumerable<ShadowFor> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<ShadowFor> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<ShadowFor> Retrieve(ManagementScope managementScope)
        {
