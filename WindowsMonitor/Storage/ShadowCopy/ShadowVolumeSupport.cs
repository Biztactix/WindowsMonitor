...
namespace WindowsMonitor.Storage.ShadowCopy
{
    ...
    public sealed class ShadowVolumeSupport
    {
        ...
        public static IEnumerable<ShadowVolumeSupport> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<ShadowVolumeSupport> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<ShadowVolumeSupport> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new ShadowVolumeSupport
                {
