...
namespace WindowsMonitor.Storage.Logicals
{
    ...
    public sealed class LogicalFileAuditing
    {
        ...
        public static IEnumerable<LogicalFileAuditing> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<LogicalFileAuditing> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<LogicalFileAuditing> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new LogicalFileAuditing
                {
