...
namespace WindowsMonitor.Storage.Logicals
{
    /// <summary>
    /// </summary>
    public sealed class LogicalFile
    {
        ...
        public static IEnumerable<LogicalFile> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<LogicalFile> Retrieve()
        {
