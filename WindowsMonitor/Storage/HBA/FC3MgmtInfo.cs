...
namespace WindowsMonitor.Storage.HBA
{
    /// <summary>
    /// </summary>
    public sealed class FC3MgmtInfo
    {
        ...
        public static IEnumerable<FC3MgmtInfo> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<FC3MgmtInfo> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<FC3MgmtInfo> Retrieve(ManagementScope managementScope)
        {
