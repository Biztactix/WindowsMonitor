...
namespace WindowsMonitor.Storage.HBA.Msfc
{
    /// <summary>
    /// </summary>
    public sealed class NpivlunMappingInformationEx
    {
        ...
        public static IEnumerable<NpivlunMappingInformationEx> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<NpivlunMappingInformationEx> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<NpivlunMappingInformationEx> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new NpivlunMappingInformationEx
                {
