...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MS_SMHBA_FC_Port
    {
        ...
        public static IEnumerable<MS_SMHBA_FC_Port> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MS_SMHBA_FC_Port> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MS_SMHBA_FC_Port> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MS_SMHBA_FC_Port
                {
