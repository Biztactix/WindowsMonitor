...
namespace WindowsMonitor.Win32.Performance.Formatted.Network
{
    /// <summary>
    /// </summary>
    public sealed class CountersIPsecIkEv2IPv4
    {
        ...
        public static IEnumerable<CountersIPsecIkEv2IPv4> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<CountersIPsecIkEv2IPv4> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<CountersIPsecIkEv2IPv4> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new CountersIPsecIkEv2IPv4
                {
