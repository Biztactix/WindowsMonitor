...
namespace WindowsMonitor.Win32.Performance.Formatted.Network.Nat
{
    /// <summary>
    /// </summary>
    public sealed class WinNatCountersWinNattcp
    {
        ...
        public static IEnumerable<WinNatCountersWinNattcp> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<WinNatCountersWinNattcp> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<WinNatCountersWinNattcp> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new WinNatCountersWinNattcp
                {
