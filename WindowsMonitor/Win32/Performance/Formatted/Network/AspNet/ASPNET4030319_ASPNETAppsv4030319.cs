...
namespace WindowsMonitor.Win32.Performance.Formatted.Network.AspNet
{
    /// <summary>
    /// </summary>
    public sealed class Aspnet4030319AspnetAppsv4030319
    {
        ...
        public static IEnumerable<Aspnet4030319AspnetAppsv4030319> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<Aspnet4030319AspnetAppsv4030319> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<Aspnet4030319AspnetAppsv4030319> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new Aspnet4030319AspnetAppsv4030319
                {
