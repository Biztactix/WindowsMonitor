...
namespace WindowsMonitor.Win32.Performance.Formatted.Network
{
    /// <summary>
    /// </summary>
    public sealed class TcpipTcPv4
    {
        ...
        public static IEnumerable<TcpipTcPv4> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<TcpipTcPv4> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<TcpipTcPv4> Retrieve(ManagementScope managementScope)
        {
