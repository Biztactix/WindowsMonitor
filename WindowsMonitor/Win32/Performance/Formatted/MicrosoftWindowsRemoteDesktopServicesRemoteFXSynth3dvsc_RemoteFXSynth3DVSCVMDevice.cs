...
namespace WindowsMonitor.Win32.Performance.Formatted
{
    /// <summary>
    /// </summary>
    public sealed class MicrosoftWindowsRemoteDesktopServicesRemoteFxSynth3DvscRemoteFxSynth3DvscvmDevice
    {
        ...
        public static IEnumerable<MicrosoftWindowsRemoteDesktopServicesRemoteFxSynth3DvscRemoteFxSynth3DvscvmDevice> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MicrosoftWindowsRemoteDesktopServicesRemoteFxSynth3DvscRemoteFxSynth3DvscvmDevice> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MicrosoftWindowsRemoteDesktopServicesRemoteFxSynth3DvscRemoteFxSynth3DvscvmDevice> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfFormattedData_MicrosoftWindowsRemoteDesktopServicesRemoteFXSynth3dvsc_RemoteFXSynth3DVSCVMDevice");
