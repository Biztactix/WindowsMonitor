...
namespace WindowsMonitor.Win32.Performance.Formatted.DotNet
{
    ...
    public sealed class NetDataProviderforOracle
    {
        ...
        public static IEnumerable<NetDataProviderforOracle> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<NetDataProviderforOracle> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<NetDataProviderforOracle> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new NetDataProviderforOracle
                {
