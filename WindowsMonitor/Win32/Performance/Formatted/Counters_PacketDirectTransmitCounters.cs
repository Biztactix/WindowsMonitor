...
namespace WindowsMonitor.Win32.Performance.Formatted
{
    /// <summary>
    /// </summary>
    public sealed class CountersPacketDirectTransmitCounters
    {
        ...
        public static IEnumerable<CountersPacketDirectTransmitCounters> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<CountersPacketDirectTransmitCounters> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<CountersPacketDirectTransmitCounters> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new CountersPacketDirectTransmitCounters
                {
