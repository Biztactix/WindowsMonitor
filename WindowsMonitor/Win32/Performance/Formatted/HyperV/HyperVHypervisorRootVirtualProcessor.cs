...
namespace WindowsMonitor.Win32.Performance.Formatted.HyperV
{
    /// <summary>
    /// </summary>
    public sealed class HyperVHypervisorRootVirtualProcessor
    {
        ...
        public static IEnumerable<HyperVHypervisorRootVirtualProcessor> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<HyperVHypervisorRootVirtualProcessor> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<HyperVHypervisorRootVirtualProcessor> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new HyperVHypervisorRootVirtualProcessor
                {
