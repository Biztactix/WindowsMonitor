...
namespace WindowsMonitor.Win32.Performance.Formatted.HyperVisor
{
    /// <summary>
    /// </summary>
    public sealed class HyperVisorLogicalProcessor
    {
        ...
        public static IEnumerable<HyperVisorLogicalProcessor> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<HyperVisorLogicalProcessor> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<HyperVisorLogicalProcessor> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new HyperVisorLogicalProcessor
                {
