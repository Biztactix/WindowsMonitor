...
namespace WindowsMonitor.Win32.Performance.Formatted.HyperVisor
{
    /// <summary>
    /// </summary>
    public sealed class HyperVisorRootPartition
    {
        ...
        public static IEnumerable<HyperVisorRootPartition> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<HyperVisorRootPartition> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<HyperVisorRootPartition> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new HyperVisorRootPartition
                {
