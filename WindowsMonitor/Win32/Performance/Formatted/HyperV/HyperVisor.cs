...
namespace WindowsMonitor.Win32.Performance.Formatted.HyperVisor
{
    /// <summary>
    /// </summary>
    public sealed class HyperVisor
    {
        ...
        public static IEnumerable<HyperVisor> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<HyperVisor> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<HyperVisor> Retrieve(ManagementScope managementScope)
        {
