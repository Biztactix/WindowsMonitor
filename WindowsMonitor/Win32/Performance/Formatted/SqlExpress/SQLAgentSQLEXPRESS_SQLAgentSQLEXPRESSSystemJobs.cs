...
namespace WindowsMonitor.Win32.Performance.Formatted.SqlExpress
{
    /// <summary>
    /// </summary>
    public sealed class SqlAgentSqlexpressSqlAgentSqlexpressSystemJobs
    {
        ...
        public static IEnumerable<SqlAgentSqlexpressSqlAgentSqlexpressSystemJobs> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<SqlAgentSqlexpressSqlAgentSqlexpressSystemJobs> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<SqlAgentSqlexpressSqlAgentSqlexpressSystemJobs> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new SqlAgentSqlexpressSqlAgentSqlexpressSystemJobs
                {
