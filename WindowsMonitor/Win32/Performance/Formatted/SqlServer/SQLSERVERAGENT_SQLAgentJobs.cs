...
namespace WindowsMonitor.Win32.Performance.Formatted.SqlServer
{
    /// <summary>
    /// </summary>
    public sealed class SqlserveragentSqlAgentJobs
    {
        ...
        public static IEnumerable<SqlserveragentSqlAgentJobs> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<SqlserveragentSqlAgentJobs> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<SqlserveragentSqlAgentJobs> Retrieve(ManagementScope managementScope)
        {
