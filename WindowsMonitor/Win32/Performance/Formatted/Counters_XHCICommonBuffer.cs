...
namespace WindowsMonitor.Win32.Performance.Formatted
{
    /// <summary>
    /// </summary>
    public sealed class CountersXhciCommonBuffer
    {
        ...
        public static IEnumerable<CountersXhciCommonBuffer> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<CountersXhciCommonBuffer> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<CountersXhciCommonBuffer> Retrieve(ManagementScope managementScope)
        {
