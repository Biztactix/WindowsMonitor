...
namespace WindowsMonitor.Win32.Performance.Formatted.ServiceModel
{
    /// <summary>
    /// </summary>
    public sealed class ServiceModelOperation3000
    {
        ...
        public static IEnumerable<ServiceModelOperation3000> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<ServiceModelOperation3000> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<ServiceModelOperation3000> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfFormattedData_ServiceModelOperation3000_ServiceModelOperation3000");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            foreach (ManagementObject managementObject in objectCollection)
                yield return new ServiceModelOperation3000
                {
