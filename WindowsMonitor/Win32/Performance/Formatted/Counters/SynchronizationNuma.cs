...
namespace WindowsMonitor.Win32.Performance.Formatted.Counters
{
    /// <summary>
    /// </summary>
    public sealed class SynchronizationNuma
    {
        ...
        public static IEnumerable<SynchronizationNuma> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<SynchronizationNuma> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<SynchronizationNuma> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new SynchronizationNuma
                {
