...
namespace WindowsMonitor.Win32.Performance.Formatted
{
    /// <summary>
    /// </summary>
    public sealed class CountersPacerPipe
    {
        ...
        public static IEnumerable<CountersPacerPipe> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<CountersPacerPipe> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<CountersPacerPipe> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new CountersPacerPipe
                {
