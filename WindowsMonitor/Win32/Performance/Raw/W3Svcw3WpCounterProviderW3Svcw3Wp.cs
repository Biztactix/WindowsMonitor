...
namespace WindowsMonitor.Win32.Performance.Raw
{
    /// <summary>
    /// </summary>
    public sealed class W3Svcw3WpCounterProviderW3Svcw3Wp
    {
		...
		public uint Percent401HttpResponseSentBase { get; private set; }
		public uint Percent403HttpResponseSent { get; private set; }
		public uint Percent403HttpResponseSentBase { get; private set; }
		public uint Percent404HttpResponseSent { get; private set; }
		public uint Percent404HttpResponseSentBase { get; private set; }
		public uint Percent500HttpResponseSent { get; private set; }
		public uint Percent500HttpResponseSentBase { get; private set; }
        ...
        public static IEnumerable<W3Svcw3WpCounterProviderW3Svcw3Wp> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<W3Svcw3WpCounterProviderW3Svcw3Wp> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<W3Svcw3WpCounterProviderW3Svcw3Wp> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new W3Svcw3WpCounterProviderW3Svcw3Wp
                {
		 ...
		 Percent401HttpResponseSentBase = (uint) (managementObject.Properties["Percent401HTTPResponseSent_Base"]?.Value ?? default(uint)),
		 Percent403HttpResponseSent = (uint) (managementObject.Properties["Percent403HTTPResponseSent"]?.Value ?? default(uint)),
		 Percent403HttpResponseSentBase = (uint) (managementObject.Properties["Percent403HTTPResponseSent_Base"]?.Value ?? default(uint)),
		 Percent404HttpResponseSent = (uint) (managementObject.Properties["Percent404HTTPResponseSent"]?.Value ?? default(uint)),
		 Percent404HttpResponseSentBase = (uint) (managementObject.Properties["Percent404HTTPResponseSent_Base"]?.Value ?? default(uint)),
		 Percent500HttpResponseSent = (uint) (managementObject.Properties["Percent500HTTPResponseSent"]?.Value ?? default(uint)),
		 Percent500HttpResponseSentBase = (uint) (managementObject.Properties["Percent500HTTPResponseSent_Base"]?.Value ?? default(uint)),
