...
namespace WindowsMonitor.Performance.Raw
{
    ...
    public sealed class SqlServer2016XTPDatabases
    {
        ...
        public static IEnumerable<SqlServer2016XTPDatabases> Retrieve(ManagementScope managementScope)
        {
		 ...
		 AvgTransactionSegmentLargeDataSize_Base = (uint) (managementObject.Properties["AvgTransactionSegmentLargeDataSize_Base"]?.Value ?? default(uint)),
		 AvgTransactionSegmentSize = (ulong) (managementObject.Properties["AvgTransactionSegmentSize"]?.Value ?? default(ulong)),
		 AvgTransactionSegmentSize_Base = (uint) (managementObject.Properties["AvgTransactionSegmentSize_Base"]?.Value ?? default(uint)),
		 ...
		 MtLog256KPageFillPercentPerPageFlushed_Base = (uint) (managementObject.Properties["MtLog256KPageFillPercentPerPageFlushed_Base"]?.Value ?? default(uint)),
		 ...
		 MtLog4KPageFillPercentPerPageFlushed_Base = (uint) (managementObject.Properties["MtLog4KPageFillPercentPerPageFlushed_Base"]?.Value ?? default(uint)),
		 ...
		 MtLog64KPageFillPercentPerPageFlushed_Base = (uint) (managementObject.Properties["MtLog64KPageFillPercentPerPageFlushed_Base"]?.Value ?? default(uint)),
