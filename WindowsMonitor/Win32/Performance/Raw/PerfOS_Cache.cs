...
namespace WindowsMonitor.Performance.Raw
{
    ...
    public sealed class PerfOS_Cache
    {
        ...
        public static IEnumerable<PerfOS_Cache> Retrieve(ManagementScope managementScope)
        {
		 ...
		 CopyReadHitsPercent_Base = (uint) (managementObject.Properties["CopyReadHitsPercent_Base"]?.Value ?? default(uint)),
		 ...
		 DataMapHitsPercent_Base = (uint) (managementObject.Properties["DataMapHitsPercent_Base"]?.Value ?? default(uint)),
		 DataMapPinsPersec = (uint) (managementObject.Properties["DataMapPinsPersec"]?.Value ?? default(uint)),
		 DataMapPinsPersec_Base = (uint) (managementObject.Properties["DataMapPinsPersec_Base"]?.Value ?? default(uint)),
		 ...
		 MDLReadHitsPercent_Base = (uint) (managementObject.Properties["MDLReadHitsPercent_Base"]?.Value ?? default(uint)),
		 ...
		 PinReadHitsPercent_Base = (uint) (managementObject.Properties["PinReadHitsPercent_Base"]?.Value ?? default(uint)),
