...
namespace WindowsMonitor.Win32.Performance.Raw.SqlExpress
{
    /// <summary>
    /// </summary>
    public sealed class SqlAgentSqlexpressSqlAgentSqlexpressAlerts
    {
        ...
        public static IEnumerable<SqlAgentSqlexpressSqlAgentSqlexpressAlerts> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<SqlAgentSqlexpressSqlAgentSqlexpressAlerts> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<SqlAgentSqlexpressSqlAgentSqlexpressAlerts> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new SqlAgentSqlexpressSqlAgentSqlexpressAlerts
                {
