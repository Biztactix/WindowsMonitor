...
namespace WindowsMonitor.Win32.Performance.Raw.Counters
{
    ...
    public sealed class StorageSpacesTier
    {
		...
		public uint AvgTierBytesPerReadBase { get; private set; }
		public ulong AvgTierBytesPerTransfer { get; private set; }
		public uint AvgTierBytesPerTransferBase { get; private set; }
		public ulong AvgTierBytesPerWrite { get; private set; }
		public uint AvgTierBytesPerWriteBase { get; private set; }
		...
		public uint AvgTiersecPerReadBase { get; private set; }
		public uint AvgTiersecPerTransfer { get; private set; }
		public uint AvgTiersecPerTransferBase { get; private set; }
		public uint AvgTiersecPerWrite { get; private set; }
		public uint AvgTiersecPerWriteBase { get; private set; }
        ...
        public static IEnumerable<StorageSpacesTier> Retrieve(ManagementScope managementScope)
        {
		 ...
		 AvgTierBytesPerReadBase = (uint) (managementObject.Properties["AvgTierBytesPerRead_Base"]?.Value ?? default(uint)),
		 AvgTierBytesPerTransfer = (ulong) (managementObject.Properties["AvgTierBytesPerTransfer"]?.Value ?? default(ulong)),
		 AvgTierBytesPerTransferBase = (uint) (managementObject.Properties["AvgTierBytesPerTransfer_Base"]?.Value ?? default(uint)),
		 AvgTierBytesPerWrite = (ulong) (managementObject.Properties["AvgTierBytesPerWrite"]?.Value ?? default(ulong)),
		 AvgTierBytesPerWriteBase = (uint) (managementObject.Properties["AvgTierBytesPerWrite_Base"]?.Value ?? default(uint)),
		 ...
		 AvgTiersecPerReadBase = (uint) (managementObject.Properties["AvgTiersecPerRead_Base"]?.Value ?? default(uint)),
		 AvgTiersecPerTransfer = (uint) (managementObject.Properties["AvgTiersecPerTransfer"]?.Value ?? default(uint)),
		 AvgTiersecPerTransferBase = (uint) (managementObject.Properties["AvgTiersecPerTransfer_Base"]?.Value ?? default(uint)),
		 AvgTiersecPerWrite = (uint) (managementObject.Properties["AvgTiersecPerWrite"]?.Value ?? default(uint)),
		 AvgTiersecPerWriteBase = (uint) (managementObject.Properties["AvgTiersecPerWrite_Base"]?.Value ?? default(uint)),
