...
namespace WindowsMonitor.Win32.Performance.Raw.Counters
{
    ...
    public sealed class Netlogon
    {
		...
		public uint AverageSemaphoreHoldTimeBase { get; private set; }
		...
		public uint LastAuthenticationTimeBase { get; private set; }
        ...
        public static IEnumerable<Netlogon> Retrieve(ManagementScope managementScope)
        {
		 ...
		 AverageSemaphoreHoldTimeBase = (uint) (managementObject.Properties["AverageSemaphoreHoldTime_Base"]?.Value ?? default(uint)),
		 ...
		 LastAuthenticationTimeBase = (uint) (managementObject.Properties["LastAuthenticationTime_Base"]?.Value ?? default(uint)),
