...
namespace WindowsMonitor.Win32.Performance.Raw.Counters
{
    ...
    public sealed class WfPv4
    {
        ...
        public static IEnumerable<WfPv4> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<WfPv4> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<WfPv4> Retrieve(ManagementScope managementScope)
        {
