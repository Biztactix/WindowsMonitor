...
namespace WindowsMonitor.Win32.Performance.Raw.DotNet
{
    /// <summary>
    /// </summary>
    public sealed class NetFrameworkNetclrMemory
    {
		...
		public uint PercentTimeinGcBase { get; private set; }
        ...
        public static IEnumerable<NetFrameworkNetclrMemory> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<NetFrameworkNetclrMemory> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<NetFrameworkNetclrMemory> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new NetFrameworkNetclrMemory
                {
		 ...
		 PercentTimeinGcBase = (uint) (managementObject.Properties["PercentTimeinGC_Base"]?.Value ?? default(uint)),
