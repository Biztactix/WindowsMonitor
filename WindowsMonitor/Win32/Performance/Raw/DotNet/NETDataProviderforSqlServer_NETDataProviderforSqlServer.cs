...
namespace WindowsMonitor.Win32.Performance.Raw.DotNet
{
    /// <summary>
    /// </summary>
    public sealed class NetDataProviderforSqlServerNetDataProviderforSqlServer
    {
        ...
        public static IEnumerable<NetDataProviderforSqlServerNetDataProviderforSqlServer> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<NetDataProviderforSqlServerNetDataProviderforSqlServer> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<NetDataProviderforSqlServerNetDataProviderforSqlServer> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new NetDataProviderforSqlServerNetDataProviderforSqlServer
                {
