...
namespace WindowsMonitor.Win32.Performance.Raw
{
    /// <summary>
    /// </summary>
    public sealed class PowerMeterCounterEnergyMeter
    {
        ...
        public static IEnumerable<PowerMeterCounterEnergyMeter> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<PowerMeterCounterEnergyMeter> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<PowerMeterCounterEnergyMeter> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new PowerMeterCounterEnergyMeter
                {
