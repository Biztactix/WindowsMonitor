...
namespace WindowsMonitor.Win32.Performance.Raw.HyperVisor
{
    /// <summary>
    /// </summary>
    public sealed class HvStatsHyperVHypervisorRootPartition
    {
		...
		public ulong IotlbFlushCostBase { get; private set; }
        ...
        public static IEnumerable<HvStatsHyperVHypervisorRootPartition> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<HvStatsHyperVHypervisorRootPartition> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<HvStatsHyperVHypervisorRootPartition> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new HvStatsHyperVHypervisorRootPartition
                {
		 ...
		 IotlbFlushCostBase = (ulong) (managementObject.Properties["IOTLBFlushCost_Base"]?.Value ?? default(ulong)),
