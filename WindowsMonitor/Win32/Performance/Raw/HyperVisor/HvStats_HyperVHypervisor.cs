...
namespace WindowsMonitor.Win32.Performance.Raw.HyperVisor
{
    /// <summary>
    /// </summary>
    public sealed class HvStatsHyperVHypervisor
    {
        ...
        public static IEnumerable<HvStatsHyperVHypervisor> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<HvStatsHyperVHypervisor> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<HvStatsHyperVHypervisor> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new HvStatsHyperVHypervisor
                {
