...
namespace WindowsMonitor.Performance.Raw
{
    /// <summary>
    /// </summary>
    public sealed class Counters_PacketDirectTransmitCounters
    {
        ...
        public static IEnumerable<Counters_PacketDirectTransmitCounters> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<Counters_PacketDirectTransmitCounters> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<Counters_PacketDirectTransmitCounters> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new Counters_PacketDirectTransmitCounters
                {
