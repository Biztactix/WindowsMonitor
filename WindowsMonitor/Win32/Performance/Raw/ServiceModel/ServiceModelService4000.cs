...
namespace WindowsMonitor.Win32.Performance.Raw.ServiceModel
{
    /// <summary>
    /// </summary>
    public sealed class ServiceModelService4000
    {
        ...
        public static IEnumerable<ServiceModelService4000> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<ServiceModelService4000> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<ServiceModelService4000> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_ServiceModel4000_ServiceModelService4000");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            foreach (ManagementObject managementObject in objectCollection)
                yield return new ServiceModelService4000
                {
