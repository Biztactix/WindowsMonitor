...
namespace WindowsMonitor.Win32.Performance.Raw
{
    ...
    public sealed class W3SvcWebServiceCache
    {
		...
		public uint FileCacheHitsPercentBase { get; private set; }
		...
		public uint KernelUriCacheHitsPercentBase { get; private set; }
		...
		public uint MetadataCacheHitsPercentBase { get; private set; }
		...
		public uint OutputCacheCurrentHitsPercentBase { get; private set; }
		...
		public uint UriCacheHitsPercentBase { get; private set; }
        ...
        public static IEnumerable<W3SvcWebServiceCache> Retrieve(ManagementScope managementScope)
        {
		 ...
		 FileCacheHitsPercentBase = (uint) (managementObject.Properties["FileCacheHitsPercent_Base"]?.Value ?? default(uint)),
		 ...
		 KernelUriCacheHitsPercentBase = (uint) (managementObject.Properties["KernelURICacheHitsPercent_Base"]?.Value ?? default(uint)),
		 ...
		 MetadataCacheHitsPercentBase = (uint) (managementObject.Properties["MetadataCacheHitsPercent_Base"]?.Value ?? default(uint)),
		 ...
		 OutputCacheCurrentHitsPercentBase = (uint) (managementObject.Properties["OutputCacheCurrentHitsPercent_Base"]?.Value ?? default(uint)),
		 ...
		 UriCacheHitsPercentBase = (uint) (managementObject.Properties["URICacheHitsPercent_Base"]?.Value ?? default(uint)),
