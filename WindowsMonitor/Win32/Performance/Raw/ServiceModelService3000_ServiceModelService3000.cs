...
namespace WindowsMonitor.Performance.Raw
{
    /// <summary>
    /// </summary>
    public sealed class ServiceModelService3000_ServiceModelService3000
    {
        ...
        public static IEnumerable<ServiceModelService3000_ServiceModelService3000> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<ServiceModelService3000_ServiceModelService3000> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<ServiceModelService3000_ServiceModelService3000> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_ServiceModelService3000_ServiceModelService3000");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            foreach (ManagementObject managementObject in objectCollection)
                yield return new ServiceModelService3000_ServiceModelService3000
                {
