...
namespace WindowsMonitor.Win32.Performance.Raw.PerfOs
{
    /// <summary>
    /// </summary>
    public sealed class PerfProc_Process
    {
        ...
        public static IEnumerable<PerfProc_Process> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<PerfProc_Process> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<PerfProc_Process> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new PerfProc_Process
                {
