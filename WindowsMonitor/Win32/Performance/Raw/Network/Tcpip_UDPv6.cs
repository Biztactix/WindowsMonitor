...
namespace WindowsMonitor.Win32.Performance.Raw.Network
{
    /// <summary>
    /// </summary>
    public sealed class TcpipUdPv6
    {
        ...
        public static IEnumerable<TcpipUdPv6> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<TcpipUdPv6> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<TcpipUdPv6> Retrieve(ManagementScope managementScope)
        {
