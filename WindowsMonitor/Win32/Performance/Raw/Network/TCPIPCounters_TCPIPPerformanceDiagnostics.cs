...
namespace WindowsMonitor.Win32.Performance.Raw.Network
{
    ...
    public sealed class TcpipCountersTcpipPerformanceDiagnostics
    {
        ...
        public static IEnumerable<TcpipCountersTcpipPerformanceDiagnostics> Retrieve(string remote, string username, string password)
        {
        ...
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_TCPIPCounters_TCPIPPerformanceDiagnostics");
