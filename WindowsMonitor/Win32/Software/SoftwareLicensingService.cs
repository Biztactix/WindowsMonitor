...
namespace WindowsMonitor
{
    ...
    public sealed class SoftwareLicensingService
    {
        ...
        public static IEnumerable<SoftwareLicensingService> Retrieve(ManagementScope managementScope)
        {
		 ...
		 OA3xOriginalProductKey = (string) (managementObject.Properties["OA3xOriginalProductKey"]?.Value ?? default(string)),
		 OA3xOriginalProductKeyDescription = (string) (managementObject.Properties["OA3xOriginalProductKeyDescription"]?.Value ?? default(string)),
		 OA3xOriginalProductKeyPkPn = (string) (managementObject.Properties["OA3xOriginalProductKeyPkPn"]?.Value ?? default(string)),
