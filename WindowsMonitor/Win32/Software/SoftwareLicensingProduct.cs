...
namespace WindowsMonitor
{
    ...
    public sealed class SoftwareLicensingProduct
    {
        ...
        public static IEnumerable<SoftwareLicensingProduct> Retrieve(ManagementScope managementScope)
        {
		 ...
		 AutomaticVMActivationLastActivationTime = ManagementDateTimeConverter.ToDateTime (managementObject.Properties["AutomaticVMActivationLastActivationTime"]?.Value as string ?? "00010101000000.000000+060"),
		 ...
		 EvaluationEndDate = ManagementDateTimeConverter.ToDateTime (managementObject.Properties["EvaluationEndDate"]?.Value as string ?? "00010101000000.000000+060"),
		 ...
		 TrustedTime = ManagementDateTimeConverter.ToDateTime (managementObject.Properties["TrustedTime"]?.Value as string ?? "00010101000000.000000+060"),
