...
namespace WindowsMonitor.Win32.Network
{
    ...
    public sealed class NetworkAdapterConfiguration
    {
        ...
        public static IEnumerable<NetworkAdapterConfiguration> Retrieve(ManagementScope managementScope)
        {
		 ...
		 DHCPLeaseExpires = ManagementDateTimeConverter.ToDateTime (managementObject.Properties["DHCPLeaseExpires"]?.Value as string ?? "00010101000000.000000+060"),
		 DHCPLeaseObtained = ManagementDateTimeConverter.ToDateTime (managementObject.Properties["DHCPLeaseObtained"]?.Value as string ?? "00010101000000.000000+060"),
