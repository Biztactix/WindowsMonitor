    ...
    public sealed class NetworkLoginProfile
    {
        ...
        public static IEnumerable<NetworkLoginProfile> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                ...
                {
                     AccountExpires = ManagementDateTimeConverter.ToDateTime (managementObject.Properties["AccountExpires"]?.Value as string ?? "00010101000000.000000+060"),
		 ...
		 LastLogoff = ManagementDateTimeConverter.ToDateTime (managementObject.Properties["LastLogoff"]?.Value as string ?? "00010101000000.000000+060"),
		 LastLogon = ManagementDateTimeConverter.ToDateTime (managementObject.Properties["LastLogon"]?.Value as string ?? "00010101000000.000000+060"),
		 ...
		 PasswordAge = ManagementDateTimeConverter.ToDateTime (managementObject.Properties["PasswordAge"]?.Value as string ?? "00010101000000.000000+060"),
		 PasswordExpires = ManagementDateTimeConverter.ToDateTime (managementObject.Properties["PasswordExpires"]?.Value as string ?? "00010101000000.000000+060"),
