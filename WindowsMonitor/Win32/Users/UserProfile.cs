...
namespace WindowsMonitor.Win32
{
    ...
    public sealed class UserProfile
    {
        ...
        public static IEnumerable<UserProfile> Retrieve(ManagementScope managementScope)
        {
		 ...
		 LastAttemptedProfileDownloadTime = ManagementDateTimeConverter.ToDateTime (managementObject.Properties["LastAttemptedProfileDownloadTime"]?.Value as string ?? "00010101000000.000000+060"),
		 LastAttemptedProfileUploadTime = ManagementDateTimeConverter.ToDateTime (managementObject.Properties["LastAttemptedProfileUploadTime"]?.Value as string ?? "00010101000000.000000+060"),
		 LastBackgroundRegistryUploadTime = ManagementDateTimeConverter.ToDateTime (managementObject.Properties["LastBackgroundRegistryUploadTime"]?.Value as string ?? "00010101000000.000000+060"),
		 LastDownloadTime = ManagementDateTimeConverter.ToDateTime (managementObject.Properties["LastDownloadTime"]?.Value as string ?? "00010101000000.000000+060"),
		 LastUploadTime = ManagementDateTimeConverter.ToDateTime (managementObject.Properties["LastUploadTime"]?.Value as string ?? "00010101000000.000000+060"),
		 LastUseTime = ManagementDateTimeConverter.ToDateTime (managementObject.Properties["LastUseTime"]?.Value as string ?? "00010101000000.000000+060"),
