...
namespace WindowsMonitor.Win32
{
    ...
    public sealed class ComputerSystem
    {
        ...
        public static IEnumerable<ComputerSystem> Retrieve(ManagementScope managementScope)
        {
		 ...
		 BootupState = (string) (managementObject.Properties["BootupState"]?.Value ?? default(string)),
		 Caption = (string) (managementObject.Properties["Caption"]?.Value ?? default(string)),
		 ChassisBootupState = (ushort) (managementObject.Properties["ChassisBootupState"]?.Value ?? default(ushort)),
		 ChassisSKUNumber = (string) (managementObject.Properties["ChassisSKUNumber"]?.Value ?? default(string)),
		 ...
		 SystemSKUNumber = (string) (managementObject.Properties["SystemSKUNumber"]?.Value ?? default(string)),
		 ...
		 SystemType = (string) (managementObject.Properties["SystemType"]?.Value ?? default(string)),
		 ...
		 Workgroup = (string) (managementObject.Properties["Workgroup"]?.Value ?? default(string))
                };
        }
    }
}