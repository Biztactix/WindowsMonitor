...
namespace WindowsMonitor.Win32.Win32Reg
{
    /// <summary>
    /// </summary>
    public sealed class AddRemovePrograms64
    {
        ...
        public static IEnumerable<AddRemovePrograms64> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<AddRemovePrograms64> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<AddRemovePrograms64> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new AddRemovePrograms64
                {
