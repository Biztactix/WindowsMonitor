...
namespace WindowsMonitor.Win32.Users
{
    ...
    public sealed class Account
    {
        ...
        public static IEnumerable<Account> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<Account> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<Account> Retrieve(ManagementScope managementScope)
        {
