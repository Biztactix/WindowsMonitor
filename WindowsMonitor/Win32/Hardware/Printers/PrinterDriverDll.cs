...
namespace WindowsMonitor.Win32.Hardware.Printers
{
    ...
    public sealed class PrinterDriverDll
    {
        ...
        public static IEnumerable<PrinterDriverDll> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<PrinterDriverDll> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<PrinterDriverDll> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new PrinterDriverDll
                {
