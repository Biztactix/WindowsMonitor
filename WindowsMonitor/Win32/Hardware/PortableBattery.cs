...
namespace WindowsMonitor.Win32
{
    ...
    public sealed class PortableBattery
    {
        ...
        public static IEnumerable<PortableBattery> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<PortableBattery> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<PortableBattery> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new PortableBattery
                {
                     Availability = (ushort) (managementObject.Properties["Availability"]?.Value ?? default(ushort)),
		 BatteryStatus = (ushort) (managementObject.Properties["BatteryStatus"]?.Value ?? default(ushort)),
		 CapacityMultiplier = (ushort) (managementObject.Properties["CapacityMultiplier"]?.Value ?? default(ushort)),
		 ...
		 ManufactureDate = (string) (managementObject.Properties["ManufactureDate"]?.Value ?? default(string)),
		 Manufacturer = (string) (managementObject.Properties["Manufacturer"]?.Value ?? default(string)),
		 MaxBatteryError = (ushort) (managementObject.Properties["MaxBatteryError"]?.Value ?? default(ushort)),
		 ...
		 SmartBatteryVersion = (string) (managementObject.Properties["SmartBatteryVersion"]?.Value ?? default(string)),
