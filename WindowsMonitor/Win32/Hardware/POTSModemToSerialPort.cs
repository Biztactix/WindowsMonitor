...
namespace WindowsMonitor.Win32.Hardware
{
    /// <summary>
    /// </summary>
    public sealed class POTSModemToSerialPort
    {
        ...
        public static IEnumerable<POTSModemToSerialPort> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<POTSModemToSerialPort> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<POTSModemToSerialPort> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new POTSModemToSerialPort
                {
