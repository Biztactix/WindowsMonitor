...
namespace WindowsMonitor.Win32.Hardware
{
    ...
    public sealed class ControllerHasHub
    {
        ...
        public static IEnumerable<ControllerHasHub> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<ControllerHasHub> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<ControllerHasHub> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new ControllerHasHub
                {
