...
namespace WindowsMonitor.Win32.Hardware.Ports
{
    /// <summary>
    /// </summary>
    public sealed class SerialPortConfiguration
    {
        ...
        public static IEnumerable<SerialPortConfiguration> Retrieve(ManagementScope managementScope)
        {
		 ...
		 DTRFlowControlType = (string) (managementObject.Properties["DTRFlowControlType"]?.Value ?? default(string)),
		 ...
		 Parity = (string) (managementObject.Properties["Parity"]?.Value ?? default(string)),
		 ParityCheckEnabled = (bool) (managementObject.Properties["ParityCheckEnabled"]?.Value ?? default(bool)),
		 RTSFlowControlType = (string) (managementObject.Properties["RTSFlowControlType"]?.Value ?? default(string)),
		 SettingID = (string) (managementObject.Properties["SettingID"]?.Value ?? default(string)),
		 StopBits = (string) (managementObject.Properties["StopBits"]?.Value ?? default(string)),
