...
namespace WindowsMonitor.Win32.Hardware.Probes
{
    /// <summary>
    /// </summary>
    public sealed class VoltageProbe
    {
        ...
        public static IEnumerable<VoltageProbe> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<VoltageProbe> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<VoltageProbe> Retrieve(ManagementScope managementScope)
        {
