...
namespace WindowsMonitor.WMI.AspNet
{
    ...
    public sealed class AspNetAppDomainEnter
    {
        ...
        public static IEnumerable<AspNetAppDomainEnter> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<AspNetAppDomainEnter> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<AspNetAppDomainEnter> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM AspNetAppDomainEnter");
