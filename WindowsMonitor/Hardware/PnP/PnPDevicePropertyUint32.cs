...
namespace WindowsMonitor.Win32.Hardware.PnP
{
    ...
    public sealed class PnPDevicePropertyUint32
    {
        ...
        public static IEnumerable<PnPDevicePropertyUint32> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<PnPDevicePropertyUint32> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<PnPDevicePropertyUint32> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new PnPDevicePropertyUint32
                {
