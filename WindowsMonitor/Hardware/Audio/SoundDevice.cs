...
namespace WindowsMonitor.Hardware.Audio
{
    ...
    public sealed class SoundDevice
    {
        ...
        public static IEnumerable<SoundDevice> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<SoundDevice> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<SoundDevice> Retrieve(ManagementScope managementScope)
        {
