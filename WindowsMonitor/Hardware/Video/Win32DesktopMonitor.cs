...
namespace WindowsMonitor.Win32.Hardware.Video
{
    /// <summary>
    /// </summary>
    public sealed class Win32DesktopMonitor
    {
        ...
        public static IEnumerable<Win32DesktopMonitor> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<Win32DesktopMonitor> Retrieve()
        {
