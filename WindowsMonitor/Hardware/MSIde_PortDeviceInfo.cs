...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MSIde_PortDeviceInfo
    {
        ...
        public static IEnumerable<MSIde_PortDeviceInfo> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSIde_PortDeviceInfo> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSIde_PortDeviceInfo> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSIde_PortDeviceInfo
                {
