...
namespace WindowsMonitor.Hardware.Cooling
{
    /// <summary>
    /// </summary>
    public sealed class MSAcpi_ThermalZoneTemperature
    {
        ...
        public static IEnumerable<MSAcpi_ThermalZoneTemperature> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSAcpi_ThermalZoneTemperature> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSAcpi_ThermalZoneTemperature> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSAcpi_ThermalZoneTemperature
                {
