...
namespace WindowsMonitor.Win32.Hardware.Cooling
{
    /// <summary>
    /// </summary>
    public sealed class Win32HeatPipe
    {
        ...
        public static IEnumerable<Win32HeatPipe> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<Win32HeatPipe> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<Win32HeatPipe> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new Win32HeatPipe
                {
