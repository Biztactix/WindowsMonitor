...
namespace WindowsMonitor.Hardware.Drives
{
    /// <summary>
    /// </summary>
    public sealed class MSDiskDriver_PerformanceData
    {
        ...
        public static IEnumerable<MSDiskDriver_PerformanceData> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MSDiskDriver_PerformanceData> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MSDiskDriver_PerformanceData> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MSDiskDriver_PerformanceData
                {
