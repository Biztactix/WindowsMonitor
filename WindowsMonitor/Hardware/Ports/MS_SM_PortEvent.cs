...
namespace WindowsMonitor.WMI
{
    /// <summary>
    /// </summary>
    public sealed class MS_SM_PortEvent
    {
        ...
        public static IEnumerable<MS_SM_PortEvent> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MS_SM_PortEvent> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MS_SM_PortEvent> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MS_SM_PortEvent
                {
