...
namespace WindowsMonitor.Win32.Hardware.Memory
{
    ...
    public sealed class MemoryArrayLocation
    {
        ...
        public static IEnumerable<MemoryArrayLocation> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MemoryArrayLocation> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MemoryArrayLocation> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MemoryArrayLocation
                {
