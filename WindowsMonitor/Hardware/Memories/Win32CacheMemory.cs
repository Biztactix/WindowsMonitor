...
namespace WindowsMonitor.Hardware.Memories
{
    /// <summary>
    /// </summary>
    public sealed class Win32CacheMemory
    {
        ...
        public static IEnumerable<Win32CacheMemory> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<Win32CacheMemory> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<Win32CacheMemory> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new Win32CacheMemory
                {
