...
namespace WindowsMonitor.CIM.Hardware.Memories
{
    ...
    public sealed class Memory
    {
        ...
        public static IEnumerable<Memory> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<Memory> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<Memory> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM CIM_Memory");
