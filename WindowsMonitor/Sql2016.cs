...
namespace WindowsMonitor
{
    ...
    public sealed class Sql2016
    {
        ...
        public static IEnumerable<Sql2016> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<Sql2016> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<Sql2016> Retrieve(ManagementScope managementScope)
        {
