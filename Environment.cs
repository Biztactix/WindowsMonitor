...
namespace ComputerManagment
{
    ...
    public sealed class Environment
    {
        ...
        public static Environment[] Retrieve(string remote, string username, string password)
        {
        ...
        public static Environment[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static Environment[] Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new Environment
                {
                    ...
                    SystemVariable = (bool) managementObject.Properties["SystemVariable"].Value,
