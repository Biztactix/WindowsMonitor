...
namespace WindowsMonitor
{
    ...
    public sealed class SQL_2012
    {
        ...
        public static IEnumerable<SQL_2012> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<SQL_2012> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<SQL_2012> Retrieve(ManagementScope managementScope)
        {
