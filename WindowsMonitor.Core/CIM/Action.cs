...
namespace WindowsMonitor.CIM
{
    ...
    public sealed class Action
    {
        ...
        public static IEnumerable<Action> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<Action> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<Action> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM CIM_Action");
