...
namespace WindowsMonitor.Performance.Formatted
{
    /// <summary>
    /// </summary>
    public sealed class ServiceModelEndpoint3000_ServiceModelEndpoint3000
    {
        ...
        public static IEnumerable<ServiceModelEndpoint3000_ServiceModelEndpoint3000> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<ServiceModelEndpoint3000_ServiceModelEndpoint3000> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<ServiceModelEndpoint3000_ServiceModelEndpoint3000> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfFormattedData_ServiceModelEndpoint3000_ServiceModelEndpoint3000");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            foreach (ManagementObject managementObject in objectCollection)
                yield return new ServiceModelEndpoint3000_ServiceModelEndpoint3000
                {
