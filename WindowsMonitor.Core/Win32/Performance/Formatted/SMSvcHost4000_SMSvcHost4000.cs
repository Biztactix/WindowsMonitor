...
namespace WindowsMonitor.Performance.Formatted
{
    /// <summary>
    /// </summary>
    public sealed class SMSvcHost4000_SMSvcHost4000
    {
        ...
        public static IEnumerable<SMSvcHost4000_SMSvcHost4000> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<SMSvcHost4000_SMSvcHost4000> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<SMSvcHost4000_SMSvcHost4000> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new SMSvcHost4000_SMSvcHost4000
                {
