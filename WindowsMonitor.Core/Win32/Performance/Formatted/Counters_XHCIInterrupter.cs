...
namespace WindowsMonitor.Win32.Performance.Formatted
{
    /// <summary>
    /// </summary>
    public sealed class CountersXhciInterrupter
    {
        ...
        public static IEnumerable<CountersXhciInterrupter> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<CountersXhciInterrupter> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<CountersXhciInterrupter> Retrieve(ManagementScope managementScope)
        {
