...
namespace WindowsMonitor.Win32.Performance.Formatted.SqlExpress
{
    /// <summary>
    /// </summary>
    public sealed class SqlExpressTransactions
    {
        ...
        public static IEnumerable<SqlExpressTransactions> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<SqlExpressTransactions> Retrieve(ManagementScope managementScope)
        {
