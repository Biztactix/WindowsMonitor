...
namespace WindowsMonitor.Win32.Network
{
    ...
    public sealed class NetworkAdapterConfiguration
    {
        ...
        public static IEnumerable<NetworkAdapterConfiguration> Retrieve(ManagementScope managementScope)
        {
		 ...
		 DatabasePath = (string) (managementObject.Properties["DatabasePath"]?.Value ?? default(string)),
		 ...
		 DHCPLeaseExpires = (DateTime) (managementObject.Properties["DHCPLeaseExpires"]?.Value ?? default(DateTime)),
		 DHCPLeaseObtained = (DateTime) (managementObject.Properties["DHCPLeaseObtained"]?.Value ?? default(DateTime)),
		 DHCPServer = (string) (managementObject.Properties["DHCPServer"]?.Value ?? default(string)),
		 DNSDomain = (string) (managementObject.Properties["DNSDomain"]?.Value ?? default(string)),
		 ...
		 DNSHostName = (string) (managementObject.Properties["DNSHostName"]?.Value ?? default(string)),
		 ...
		 IPXAddress = (string) (managementObject.Properties["IPXAddress"]?.Value ?? default(string)),
		 ...
		 IPXVirtualNetNumber = (string) (managementObject.Properties["IPXVirtualNetNumber"]?.Value ?? default(string)),
		 ...
		 WINSHostLookupFile = (string) (managementObject.Properties["WINSHostLookupFile"]?.Value ?? default(string)),
		 WINSPrimaryServer = (string) (managementObject.Properties["WINSPrimaryServer"]?.Value ?? default(string)),
		 WINSScopeID = (string) (managementObject.Properties["WINSScopeID"]?.Value ?? default(string)),
		 WINSSecondaryServer = (string) (managementObject.Properties["WINSSecondaryServer"]?.Value ?? default(string))
                };
        }
    }
}