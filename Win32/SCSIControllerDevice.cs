...
namespace WindowsMonitor.Win32
{
    ...
    public sealed class SCSIControllerDevice
    {
        ...
        public static IEnumerable<SCSIControllerDevice> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<SCSIControllerDevice> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<SCSIControllerDevice> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new SCSIControllerDevice
                {
