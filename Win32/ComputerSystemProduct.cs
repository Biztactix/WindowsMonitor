...
namespace WindowsMonitor.Win32
{
    ...
    public sealed class ComputerSystemProduct
    {
        ...
        public static IEnumerable<ComputerSystemProduct> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<ComputerSystemProduct> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<ComputerSystemProduct> Retrieve(ManagementScope managementScope)
        {
