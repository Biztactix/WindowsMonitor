...
namespace WindowsMonitor.Win32.Performance.Formatted
{
    /// <summary>
    /// </summary>
    public sealed class SQLServer2016XTPDatabaseEngine_SQLServer2016XTPTransactions
    {
        ...
        public static IEnumerable<SQLServer2016XTPDatabaseEngine_SQLServer2016XTPTransactions> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<SQLServer2016XTPDatabaseEngine_SQLServer2016XTPTransactions> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<SQLServer2016XTPDatabaseEngine_SQLServer2016XTPTransactions> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfFormattedData_SQLServer2016XTPDatabaseEngine_SQLServer2016XTPTransactions");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            foreach (ManagementObject managementObject in objectCollection)
                yield return new SQLServer2016XTPDatabaseEngine_SQLServer2016XTPTransactions
                {
