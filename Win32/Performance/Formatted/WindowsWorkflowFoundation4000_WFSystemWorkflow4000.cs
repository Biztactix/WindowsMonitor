...
namespace WindowsMonitor.Win32.Performance.Formatted
{
    /// <summary>
    /// </summary>
    public sealed class WindowsWorkflowFoundation4000_WFSystemWorkflow4000
    {
        ...
        public static IEnumerable<WindowsWorkflowFoundation4000_WFSystemWorkflow4000> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<WindowsWorkflowFoundation4000_WFSystemWorkflow4000> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<WindowsWorkflowFoundation4000_WFSystemWorkflow4000> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfFormattedData_WindowsWorkflowFoundation4000_WFSystemWorkflow4000");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            foreach (ManagementObject managementObject in objectCollection)
                yield return new WindowsWorkflowFoundation4000_WFSystemWorkflow4000
                {
