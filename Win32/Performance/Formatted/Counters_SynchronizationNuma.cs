...
namespace WindowsMonitor.Win32.Performance.Formatted
{
    /// <summary>
    /// </summary>
    public sealed class Counters_SynchronizationNuma
    {
        ...
        public static IEnumerable<Counters_SynchronizationNuma> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<Counters_SynchronizationNuma> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<Counters_SynchronizationNuma> Retrieve(ManagementScope managementScope)
        {
