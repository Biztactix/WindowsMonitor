...
namespace WindowsMonitor.Win32.Performance.Formatted
{
    /// <summary>
    /// </summary>
    public sealed class ASPNET642050727_ASPNETAppsv2050727
    {
        ...
        public static IEnumerable<ASPNET642050727_ASPNETAppsv2050727> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<ASPNET642050727_ASPNETAppsv2050727> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<ASPNET642050727_ASPNETAppsv2050727> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfFormattedData_ASPNET642050727_ASPNETAppsv2050727");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            foreach (ManagementObject managementObject in objectCollection)
                yield return new ASPNET642050727_ASPNETAppsv2050727
                {
