...
namespace WindowsMonitor.Win32.Performance.Formatted
{
    /// <summary>
    /// </summary>
    public sealed class SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSSystemJobs
    {
        ...
        public static IEnumerable<SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSSystemJobs> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSSystemJobs> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSSystemJobs> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfFormattedData_SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSSystemJobs");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            foreach (ManagementObject managementObject in objectCollection)
                yield return new SQLAgentSQLEXPRESS_SQLAgentSQLEXPRESSSystemJobs
                {
