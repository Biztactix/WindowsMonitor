...
namespace WindowsMonitor.Performance.Raw
{
    /// <summary>
    /// </summary>
    public sealed class ASPNET642050727_ASPNETv2050727
    {
        ...
        public static IEnumerable<ASPNET642050727_ASPNETv2050727> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<ASPNET642050727_ASPNETv2050727> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<ASPNET642050727_ASPNETv2050727> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new ASPNET642050727_ASPNETv2050727
                {
