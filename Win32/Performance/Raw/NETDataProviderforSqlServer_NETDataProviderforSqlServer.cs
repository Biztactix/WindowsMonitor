...
namespace WindowsMonitor.Performance.Raw
{
    /// <summary>
    /// </summary>
    public sealed class NETDataProviderforSqlServer_NETDataProviderforSqlServer
    {
        ...
        public static IEnumerable<NETDataProviderforSqlServer_NETDataProviderforSqlServer> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<NETDataProviderforSqlServer_NETDataProviderforSqlServer> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<NETDataProviderforSqlServer_NETDataProviderforSqlServer> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_PerfRawData_NETDataProviderforSqlServer_NETDataProviderforSqlServer");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            foreach (ManagementObject managementObject in objectCollection)
                yield return new NETDataProviderforSqlServer_NETDataProviderforSqlServer
                {
