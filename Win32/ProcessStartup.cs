...
namespace WindowsMonitor.Win32
{
    ...
    public sealed class ProcessStartup
    {
        ...
        public static IEnumerable<ProcessStartup> Retrieve(ManagementScope managementScope)
        {
		 ...
		 Title = (string) (managementObject.Properties["Title"]?.Value ?? default(string)),
		 WinstationDesktop = (string) (managementObject.Properties["WinstationDesktop"]?.Value ?? default(string)),
