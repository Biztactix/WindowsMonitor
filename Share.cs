...
namespace ComputerManagment
{
    ...
    public sealed class Share
    {
        ...
        public static Share[] Retrieve(string remote, string username, string password)
        {
        ...
        public static Share[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static Share[] Retrieve(ManagementScope managementScope)
        {
