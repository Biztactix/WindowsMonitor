...
namespace WindowsMonitor.Msft
{
    ...
    public sealed class NetTakeOwnership
    {
        ...
        public static IEnumerable<NetTakeOwnership> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<NetTakeOwnership> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM MSFT_NetTakeOwnership");
