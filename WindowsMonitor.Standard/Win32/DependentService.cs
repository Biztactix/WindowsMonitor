...
namespace WindowsMonitor.Win32
{
    ...
    public sealed class DependentService
    {
        ...
        public static IEnumerable<DependentService> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<DependentService> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<DependentService> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new DependentService
                {
