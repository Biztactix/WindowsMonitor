...
namespace WindowsMonitor.Win32
{
    ...
    public sealed class Process
    {
        ...
        public static IEnumerable<Process> Retrieve(ManagementScope managementScope)
        {
		 ...
		 ExecutablePath = (string) (managementObject.Properties["ExecutablePath"]?.Value ?? default(string)),
		 ...
		 WindowsVersion = (string) (managementObject.Properties["WindowsVersion"]?.Value ?? default(string)),
