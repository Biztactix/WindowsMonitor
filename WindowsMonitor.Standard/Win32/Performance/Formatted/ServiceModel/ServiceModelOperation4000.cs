...
namespace WindowsMonitor.Win32.Performance.Formatted.ServiceModel
{
    /// <summary>
    /// </summary>
    public sealed class ServiceModelOperation4000
    {
        ...
        public static IEnumerable<ServiceModelOperation4000> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<ServiceModelOperation4000> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<ServiceModelOperation4000> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new ServiceModelOperation4000
                {
