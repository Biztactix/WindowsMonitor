...
namespace WindowsMonitor.Win32.Performance.Formatted.Wpf
{
    /// <summary>
    /// </summary>
    public sealed class CountersWfPv4
    {
        ...
        public static IEnumerable<CountersWfPv4> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<CountersWfPv4> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<CountersWfPv4> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new CountersWfPv4
                {
