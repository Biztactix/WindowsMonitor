...
namespace WindowsMonitor.Win32.Performance.Formatted
{
    /// <summary>
    /// </summary>
    public sealed class CountersThermalZoneInformation
    {
        ...
        public static IEnumerable<CountersThermalZoneInformation> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<CountersThermalZoneInformation> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<CountersThermalZoneInformation> Retrieve(ManagementScope managementScope)
        {
