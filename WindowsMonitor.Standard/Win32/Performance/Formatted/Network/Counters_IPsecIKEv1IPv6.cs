...
namespace WindowsMonitor.Performance.Formatted
{
    /// <summary>
    /// </summary>
    public sealed class Counters_IPsecIKEv1IPv6
    {
        ...
        public static IEnumerable<Counters_IPsecIKEv1IPv6> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<Counters_IPsecIKEv1IPv6> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<Counters_IPsecIKEv1IPv6> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new Counters_IPsecIKEv1IPv6
                {
