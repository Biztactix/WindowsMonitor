...
namespace WindowsMonitor.Win32.Performance.Formatted
{
    /// <summary>
    /// </summary>
    public sealed class CountersPacketDirectReceiveCounters
    {
        ...
        public static IEnumerable<CountersPacketDirectReceiveCounters> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<CountersPacketDirectReceiveCounters> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<CountersPacketDirectReceiveCounters> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new CountersPacketDirectReceiveCounters
                {
