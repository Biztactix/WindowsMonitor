...
namespace WindowsMonitor.Win32.Performance.Formatted
{
    /// <summary>
    /// </summary>
    public sealed class CountersPerProcessorNetworkActivityCycles
    {
        ...
        public static IEnumerable<CountersPerProcessorNetworkActivityCycles> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<CountersPerProcessorNetworkActivityCycles> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<CountersPerProcessorNetworkActivityCycles> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new CountersPerProcessorNetworkActivityCycles
                {
