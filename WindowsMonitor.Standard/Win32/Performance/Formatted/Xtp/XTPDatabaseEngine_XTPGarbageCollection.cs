...
namespace WindowsMonitor.Win32.Performance.Formatted.Xtp
{
    /// <summary>
    /// </summary>
    public sealed class XtpDatabaseEngineXtpGarbageCollection
    {
        ...
        public static IEnumerable<XtpDatabaseEngineXtpGarbageCollection> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<XtpDatabaseEngineXtpGarbageCollection> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<XtpDatabaseEngineXtpGarbageCollection> Retrieve(ManagementScope managementScope)
        {
