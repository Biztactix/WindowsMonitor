...
namespace WindowsMonitor.Win32.Performance.Formatted.DotNet
{
    ...
    public sealed class NetClrLoading
    {
        ...
        public static IEnumerable<NetClrLoading> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<NetClrLoading> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<NetClrLoading> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new NetClrLoading
                {
