...
namespace WindowsMonitor.Performance.Raw
{
    ...
    public sealed class HvStats_HyperVHypervisorRootVirtualProcessor
    {
        ...
        public static IEnumerable<HvStats_HyperVHypervisorRootVirtualProcessor> Retrieve(ManagementScope managementScope)
        {
		 ...
		 ControlRegisterAccessesCost_Base = (ulong) (managementObject.Properties["ControlRegisterAccessesCost_Base"]?.Value ?? default(ulong)),
		 ...
		 ControlRegisterAccessesForwardingCost_Base = (ulong) (managementObject.Properties["ControlRegisterAccessesForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 CPUIDInstructionsCost_Base = (ulong) (managementObject.Properties["CPUIDInstructionsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 CPUIDInstructionsForwardingCost_Base = (ulong) (managementObject.Properties["CPUIDInstructionsForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 CPUWaitTimePerDispatch_Base = (ulong) (managementObject.Properties["CPUWaitTimePerDispatch_Base"]?.Value ?? default(ulong)),
		 DebugRegisterAccessesCost = (ulong) (managementObject.Properties["DebugRegisterAccessesCost"]?.Value ?? default(ulong)),
		 DebugRegisterAccessesCost_Base = (ulong) (managementObject.Properties["DebugRegisterAccessesCost_Base"]?.Value ?? default(ulong)),
		 ...
		 DebugRegisterAccessesForwardingCost_Base = (ulong) (managementObject.Properties["DebugRegisterAccessesForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 EmulatedInstructionsCost_Base = (ulong) (managementObject.Properties["EmulatedInstructionsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 EmulatedInstructionsForwardingCost_Base = (ulong) (managementObject.Properties["EmulatedInstructionsForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 ExternalInterruptsCost_Base = (ulong) (managementObject.Properties["ExternalInterruptsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 GlobalIOTLBFlushCost_Base = (ulong) (managementObject.Properties["GlobalIOTLBFlushCost_Base"]?.Value ?? default(ulong)),
		 ...
		 HLTInstructionsCost_Base = (ulong) (managementObject.Properties["HLTInstructionsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 HLTInstructionsForwardingCost_Base = (ulong) (managementObject.Properties["HLTInstructionsForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 HypercallsCost_Base = (ulong) (managementObject.Properties["HypercallsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 HypercallsForwardingCost_Base = (ulong) (managementObject.Properties["HypercallsForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 InvEptAllContextInstructionEmulationCost_Base = (ulong) (managementObject.Properties["InvEptAllContextInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 InvEptSingleContextInstructionEmulationCost_Base = (ulong) (managementObject.Properties["InvEptSingleContextInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 InvVpidAllContextInstructionEmulationCost_Base = (ulong) (managementObject.Properties["InvVpidAllContextInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 InvVpidSingleAddressInstructionEmulationCost_Base = (ulong) (managementObject.Properties["InvVpidSingleAddressInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 InvVpidSingleContextInstructionEmulationCost_Base = (ulong) (managementObject.Properties["InvVpidSingleContextInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 IOInstructionsCost = (ulong) (managementObject.Properties["IOInstructionsCost"]?.Value ?? default(ulong)),
		 IOInstructionsCost_Base = (ulong) (managementObject.Properties["IOInstructionsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 IOInstructionsForwardingCost_Base = (ulong) (managementObject.Properties["IOInstructionsForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 LocalIOTLBFlushCost_Base = (ulong) (managementObject.Properties["LocalIOTLBFlushCost_Base"]?.Value ?? default(ulong)),
		 ...
		 MSRAccessesCost_Base = (ulong) (managementObject.Properties["MSRAccessesCost_Base"]?.Value ?? default(ulong)),
		 ...
		 MSRAccessesForwardingCost_Base = (ulong) (managementObject.Properties["MSRAccessesForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 MWAITInstructionsCost_Base = (ulong) (managementObject.Properties["MWAITInstructionsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 MWAITInstructionsForwardingCost_Base = (ulong) (managementObject.Properties["MWAITInstructionsForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 NestedPageFaultInterceptsCost_Base = (ulong) (managementObject.Properties["NestedPageFaultInterceptsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 NestedSLATHardPageFaultsCost_Base = (ulong) (managementObject.Properties["NestedSLATHardPageFaultsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 NestedSLATSoftPageFaultsCost_Base = (ulong) (managementObject.Properties["NestedSLATSoftPageFaultsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 NestedVMEntriesCost_Base = (ulong) (managementObject.Properties["NestedVMEntriesCost_Base"]?.Value ?? default(ulong)),
		 ...
		 OtherInterceptsCost_Base = (ulong) (managementObject.Properties["OtherInterceptsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 OtherInterceptsForwardingCost_Base = (ulong) (managementObject.Properties["OtherInterceptsForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 PageFaultInterceptsCost_Base = (ulong) (managementObject.Properties["PageFaultInterceptsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 PageFaultInterceptsForwardingCost_Base = (ulong) (managementObject.Properties["PageFaultInterceptsForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 PageInvalidationsCost_Base = (ulong) (managementObject.Properties["PageInvalidationsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 PageInvalidationsForwardingCost_Base = (ulong) (managementObject.Properties["PageInvalidationsForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 PendingInterruptsCost_Base = (ulong) (managementObject.Properties["PendingInterruptsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 PendingInterruptsForwardingCost_Base = (ulong) (managementObject.Properties["PendingInterruptsForwardingCost_Base"]?.Value ?? default(ulong)),
		 ...
		 PercentRemoteRunTime_Base = (ulong) (managementObject.Properties["PercentRemoteRunTime_Base"]?.Value ?? default(ulong)),
		 ...
		 TotalInterceptsCost_Base = (ulong) (managementObject.Properties["TotalInterceptsCost_Base"]?.Value ?? default(ulong)),
		 ...
		 TotalVirtualizationInstructionsEmulationCost_Base = (ulong) (managementObject.Properties["TotalVirtualizationInstructionsEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 VMCLEARInstructionEmulationCost_Base = (ulong) (managementObject.Properties["VMCLEARInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 VMPTRLDInstructionEmulationCost_Base = (ulong) (managementObject.Properties["VMPTRLDInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 VMPTRSTInstructionEmulationCost_Base = (ulong) (managementObject.Properties["VMPTRSTInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 VMREADInstructionEmulationCost_Base = (ulong) (managementObject.Properties["VMREADInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 VMWRITEInstructionEmulationCost_Base = (ulong) (managementObject.Properties["VMWRITEInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 VMXOFFInstructionEmulationCost_Base = (ulong) (managementObject.Properties["VMXOFFInstructionEmulationCost_Base"]?.Value ?? default(ulong)),
		 ...
		 VMXONInstructionEmulationCost_Base = (ulong) (managementObject.Properties["VMXONInstructionEmulationCost_Base"]?.Value ?? default(ulong))
                };
        }
    }
}