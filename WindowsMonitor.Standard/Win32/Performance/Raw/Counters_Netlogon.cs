...
namespace WindowsMonitor.Performance.Raw
{
    ...
    public sealed class Counters_Netlogon
    {
        ...
        public static IEnumerable<Counters_Netlogon> Retrieve(ManagementScope managementScope)
        {
		 ...
		 AverageSemaphoreHoldTime_Base = (uint) (managementObject.Properties["AverageSemaphoreHoldTime_Base"]?.Value ?? default(uint)),
		 ...
		 LastAuthenticationTime_Base = (uint) (managementObject.Properties["LastAuthenticationTime_Base"]?.Value ?? default(uint)),
