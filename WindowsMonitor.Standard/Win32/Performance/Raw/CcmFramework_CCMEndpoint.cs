...
namespace WindowsMonitor.Performance.Raw
{
    /// <summary>
    /// </summary>
    public sealed class CcmFramework_CCMEndpoint
    {
        ...
        public static IEnumerable<CcmFramework_CCMEndpoint> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<CcmFramework_CCMEndpoint> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<CcmFramework_CCMEndpoint> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new CcmFramework_CCMEndpoint
                {
