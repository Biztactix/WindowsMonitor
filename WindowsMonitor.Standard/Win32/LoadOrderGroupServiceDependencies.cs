...
namespace WindowsMonitor.Win32
{
    ...
    public sealed class LoadOrderGroupServiceDependencies
    {
        ...
        public static IEnumerable<LoadOrderGroupServiceDependencies> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<LoadOrderGroupServiceDependencies> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<LoadOrderGroupServiceDependencies> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new LoadOrderGroupServiceDependencies
                {
