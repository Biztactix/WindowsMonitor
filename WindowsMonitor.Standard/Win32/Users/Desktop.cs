...
namespace WindowsMonitor.Win32
{
    ...
    public sealed class Desktop
    {
        ...
        public static IEnumerable<Desktop> Retrieve(ManagementScope managementScope)
        {
		 ...
		 IconTitleFaceName = (string) (managementObject.Properties["IconTitleFaceName"]?.Value ?? default(string)),
		 ...
		 Pattern = (string) (managementObject.Properties["Pattern"]?.Value ?? default(string)),
		 ScreenSaverActive = (bool) (managementObject.Properties["ScreenSaverActive"]?.Value ?? default(bool)),
		 ScreenSaverExecutable = (string) (managementObject.Properties["ScreenSaverExecutable"]?.Value ?? default(string)),
		 ...
		 Wallpaper = (string) (managementObject.Properties["Wallpaper"]?.Value ?? default(string)),
