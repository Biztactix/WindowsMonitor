...
namespace WindowsMonitor
{
    ...
    public sealed class SQL_2008
    {
        ...
        public static IEnumerable<SQL_2008> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<SQL_2008> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<SQL_2008> Retrieve(ManagementScope managementScope)
        {
