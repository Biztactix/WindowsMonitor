...
namespace WindowsMonitor.CIM
{
    ...
    public sealed class ApplicationSystem
    {
        ...
        public static IEnumerable<ApplicationSystem> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<ApplicationSystem> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<ApplicationSystem> Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM CIM_ApplicationSystem");
