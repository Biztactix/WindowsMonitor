...
namespace WindowsMonitor
{
    /// <summary>
    /// </summary>
    public sealed class Win32Reg_SMSGuestVirtualMachine64
    {
		public string InstanceKey { get; private set; }
		public string PhysicalHostName { get; private set; }
		public string PhysicalHostNameFullyQualified { get; private set; }

        public static IEnumerable<Win32Reg_SMSGuestVirtualMachine64> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<Win32Reg_SMSGuestVirtualMachine64> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<Win32Reg_SMSGuestVirtualMachine64> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new Win32Reg_SMSGuestVirtualMachine64
                {
