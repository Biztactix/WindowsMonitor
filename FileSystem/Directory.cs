...
namespace ComputerManagment
{
    ...
    public sealed class Directory
    {
        ...
        public static Directory[] Retrieve(string remote, string username, string password)
        {
        ...
        public static Directory[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static Directory[] Retrieve(ManagementScope managementScope)
        {
