...
namespace ComputerManagment
{
    ...
    public sealed class Fan
    {
        ...
        public static Fan[] Retrieve(string remote, string username, string password)
        {
        ...
        public static Fan[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static Fan[] Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new Fan
                {
                    ActiveCooling = (bool) managementObject.Properties["ActiveCooling"].Value,
                    ...
                    DesiredSpeed = (ulong) managementObject.Properties["DesiredSpeed"].Value,
                    ...
                    VariableSpeed = (bool) managementObject.Properties["VariableSpeed"].Value
                });
