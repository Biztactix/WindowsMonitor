...
namespace ComputerManagment
{
    ...
    public sealed class InfraredDevice
    {
        ...
        public static InfraredDevice[] Retrieve(string remote, string username, string password)
        {
        ...
        public static InfraredDevice[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static InfraredDevice[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_InfraredDevice");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<InfraredDevice>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new InfraredDevice
                {
