...
namespace ComputerManagment
{
    ...
    public sealed class Controller1394
    {
        ...
        public static Controller1394[] Retrieve(string remote, string username, string password)
        {
        ...
        public static Controller1394[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static Controller1394[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_1394Controller");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<Controller1394>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new Controller1394
                {
