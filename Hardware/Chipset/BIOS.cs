...
namespace ComputerManagment
{
    ...
    public sealed class BIOS
    {
        ...
        public static BIOS[] Retrieve(string remote, string username, string password)
        {
        ...
        public static BIOS[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static BIOS[] Retrieve(ManagementScope managementScope)
        {
            var objectQuery = new ObjectQuery("SELECT * FROM Win32_BIOS");
            var objectSearcher = new ManagementObjectSearcher(managementScope, objectQuery);
            var objectCollection = objectSearcher.Get();

            var list = new List<BIOS>();

            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new BIOS
                {
                    BiosCharacteristics = (ushort[]) managementObject.Properties["BiosCharacteristics"].Value,
                    BIOSVersion = (string[]) managementObject.Properties["BIOSVersion"].Value,
                    ...
                    EmbeddedControllerMajorVersion =
                        (byte) managementObject.Properties["EmbeddedControllerMajorVersion"].Value,
                    EmbeddedControllerMinorVersion =
                        (byte) managementObject.Properties["EmbeddedControllerMinorVersion"].Value,
                    IdentificationCode = (string) managementObject.Properties["IdentificationCode"].Value,
                    InstallableLanguages = (ushort) managementObject.Properties["InstallableLanguages"].Value,
                    InstallDate = (DateTime) managementObject.Properties["InstallDate"].Value,
                    LanguageEdition = (string) managementObject.Properties["LanguageEdition"].Value,
                    ListOfLanguages = (string[]) managementObject.Properties["ListOfLanguages"].Value,
                    Manufacturer = (string) managementObject.Properties["Manufacturer"].Value,
                    Name = (string) managementObject.Properties["Name"].Value,
                    OtherTargetOS = (string) managementObject.Properties["OtherTargetOS"].Value,
                    PrimaryBIOS = (bool) managementObject.Properties["PrimaryBIOS"].Value,
                    ReleaseDate = (DateTime) managementObject.Properties["ReleaseDate"].Value,
                    ...
                    SMBIOSMajorVersion = (ushort) managementObject.Properties["SMBIOSMajorVersion"].Value,
                    SMBIOSMinorVersion = (ushort) managementObject.Properties["SMBIOSMinorVersion"].Value,
                    SMBIOSPresent = (bool) managementObject.Properties["SMBIOSPresent"].Value,
                    SoftwareElementID = (string) managementObject.Properties["SoftwareElementID"].Value,
                    SoftwareElementState = (ushort) managementObject.Properties["SoftwareElementState"].Value,
                    Status = (string) managementObject.Properties["Status"].Value,
                    SystemBiosMajorVersion = (byte) managementObject.Properties["SystemBiosMajorVersion"].Value,
                    SystemBiosMinorVersion = (byte) managementObject.Properties["SystemBiosMinorVersion"].Value,
                    TargetOperatingSystem = (ushort) managementObject.Properties["TargetOperatingSystem"].Value,
