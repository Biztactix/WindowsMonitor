...
namespace ComputerManagment
{
    ...
    public sealed class Bus
    {
        ...
        public static Bus[] Retrieve(string remote, string username, string password)
        {
        ...
        public static Bus[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static Bus[] Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new Bus
                {
                    ...
                    BusNum = (uint) managementObject.Properties["BusNum"].Value,
                    BusType = (uint) managementObject.Properties["BusType"].Value,
