...
namespace ComputerManagment
{
    ...
    public sealed class Battery
    {
        ...
        public static Battery[] Retrieve(string remote, string username, string password)
        {
        ...
        public static Battery[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static Battery[] Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                list.Add(new Battery
                {
                    ...
                    BatteryRechargeTime = (uint) managementObject.Properties["BatteryRechargeTime"].Value,
                    ...
                    ExpectedBatteryLife = (uint) managementObject.Properties["ExpectedBatteryLife"].Value,
