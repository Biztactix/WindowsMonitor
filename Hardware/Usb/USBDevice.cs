...
namespace ComputerManagment
{
    ...
    public sealed class USBDevice
    {
        ...
        public static USBDevice[] Retrieve(string remote, string username, string password)
        {
        ...
        public static USBDevice[] Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static USBDevice[] Retrieve(ManagementScope managementScope)
        {
